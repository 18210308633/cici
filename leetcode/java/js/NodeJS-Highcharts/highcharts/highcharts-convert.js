...
(function () {
    ...
    render = function (params, exitCallback) {
        ...
        scaleAndClipPage = function (svg) {
            ...
            /* ignored for PDF, see https://github.java/ariya/phantomjs/issues/10465 */
            page.clipRect = {
                top: 0,
                left: 0,
                width: clipwidth,
            ...
            if (outType === 'pdf') {
                ...
                // simulate zooming to get the right zoomFactor. Using page.zoomFactor doesn't work anymore, see issue here https://github.java/ariya/phantomjs/issues/12685
