...
(function () {
    ...
    function X(a, b, c) {
        var d, e;
        if (Ia(b))t(c) ? a.setAttribute(b, c) : a && a.getAttribute && (e = a.getAttribute(b)); else if (t(b) && ha(b))for (d in b)a.setAttribute(d, b[d]);
        return e
    }
    ...
    function oa(a, b) {
        var c = "Highcharts error #" + a + ": www.highcharts.java/errors/" + a;
        if (b)throw c;
    ...
    var s, F = document, U = window, Y = Math, x = Y.round, T = Y.floor, za = Y.ceil, v = Y.max, E = Y.min, Q = Y.abs, ba = Y.cos, ga = Y.sin, ua = Y.PI, pa = ua * 2 / 360, Ga = navigator.userAgent, Tb = U.opera, ya = /(msie|trident|edge)/i.test(Ga) && !Tb, nb = F.documentMode === 8, ob = !ya && /AppleWebKit/.test(Ga), Ua = /Firefox/.test(Ga), eb = /(Mobile|Android|Windows Phone)/.test(Ga), Na = "http://www.w3.org/2000/svg",
        ea = !!F.createElementNS && !!F.createElementNS(Na, "svg").createSVGRect, Yb = Ua && parseInt(Ga.split("Firefox/")[1], 10) < 4, ma = !ea && !ya && !!F.createElement("canvas").getContext, Va, Za, Ub = {}, Hb = 0, lb, N, ja, Ib, J, ka = function () {
            return s
        }, ca = [], fb = 0, Ta = "div", $ = "none", Zb = /^[0-9]+$/, pb = ["plotTop", "marginRight", "marginBottom", "plotLeft"], $b = "stroke-width", fa, mb, vb, kb, zb, Ab, Bb, bb, cb, db, Ob, Pb, Qb, Rb, Cb, Db, Eb, K = {}, D;
    ...
    ja = function (a, b, c) {
        ...
        var a = p(a, "%Y-%m-%d %H:%M:%S"), d = new fa(b - ab(b)), e, f = d[Ab](), g = d[Bb](), h = d[bb](), i = d[cb](), k = d[db](), j = N.lang, m = j.weekdays, d = w({
            a: m[g].substr(0, 3),
            A: m[g],
            d: Qa(h),
            e: h,
    ...
    D.numberFormat = function (a, b, c, d) {
        var e = N.lang, a = +a || 0, f = b === -1 ? E((a.toString().split(".")[1] || "").length, 20) : isNaN(b = Q(b)) ? 2 : b, b = c === void 0 ? e.decimalPoint : c, d = d === void 0 ? e.thousandsSep : d, e = a < 0 ? "-" : "", c = String(I(a = Q(a).toFixed(f))), g = c.length > 3 ? c.length % 3 : 0;
    ...
    Ib = {
        init: function (a, b, c) {
            ...
            var e = [], f = a.length;
            if (c === 1)e = d; else if (f === b.length && c < 1)for (; f--;)d = parseFloat(a[f]), e[f] = isNaN(d) ? a[f] : c * parseFloat(b[f] - d) +
            d; else e = b;
            return e
        }
    };
    ...
    var S = U.HighchartsAdapter, M = S || {};
    S && S.init.call(S, Ib);
    var qb = M.adapterRun, ac = M.getScript, Oa = M.inArray, o = D.each = M.each, gb = M.grep, bc =
        M.offset, Aa = M.map, A = M.addEvent, V = M.removeEvent, O = M.fireEvent, cc = M.washMouseEvent, rb = M.animate, $a = M.stop;
    N = {
        ...
        global: {
            useUTC: !0,
            canvasToolsURL: "http://code.highcharts.java/stock/2.1.9/modules/canvas-tools.js",
            VMLRadialGradientURL: "http://code.highcharts.java/stock/2.1.9/gfx/vml-radial-gradient.png"
        },
        chart: {
            borderColor: "#4572A7",
            borderRadius: 0,
        ...
        credits: {
            enabled: !0,
            text: "Highcharts.java",
            href: "http://www.highcharts.java",
            position: {align: "right", x: -10, verticalAlign: "bottom", y: -5},
            style: {cursor: "pointer", color: "#909090", fontSize: "9px"}
        }
    };
    var W = N.plotOptions, S = W.line;
    Nb();
    var dc = /rgba\(\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*,\s*([0-9]?(?:\.[0-9]+)?)\s*\)/, ec = /#([a-fA-F0-9]{2})([a-fA-F0-9]{2})([a-fA-F0-9]{2})/,
        fc = /rgb\(\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*\)/, va = function (a) {
            var b = [], c, d;
            (function (a) {
    ...
    Z.prototype = {
        ...
        colorGradient: function (a, b, c) {
            var d = this.renderer, e, f, g, h, i, k, j, m, l, n, q, r = [];
            ...
            if (f) {
                ...
                (h = g, g = B(g, d.getRadialAttr(n, h), {gradientUnits: "userSpaceOnUse"}));
        ...
        applyTextShadow: function (a) {
            var b = this.element, c, d = a.indexOf("contrast") !== -1, e = {}, f = this.renderer.forExport, g = f || b.style.textShadow !== s && !ya;
        ...
        css: function (a) {
            ...
            if (e) {
                ...
                if (ya && !ea)G(this.element, a); else {
                    b = function (a, b) {
        ...
        getBBox: function (a) {
            var b, c = this.renderer, d, e = this.rotation, f = this.element, g = this.styles, h = e * pa;
            d = this.textStr;
            var i, k = f.style, j, m;
        ...
        zIndexSetter: function (a, b) {
            ...
            if (e) {
                ...
                d = c.childNodes;
                for (i = 0; i < d.length && !h; i++)if (e = d[i], f = X(e, "zIndex"), e !== g && (I(f) > a || !t(a) && t(f)))c.insertBefore(g, e), h = !0;
                h || c.appendChild(g)
            }
            return h
        },
    ...
    Z.prototype["stroke-widthSetter"] = Z.prototype.strokeSetter = function (a, b, c) {
        this[b] = a;
        if (this.stroke && this["stroke-width"])this.strokeWidth = this["stroke-width"], Z.prototype.fillSetter.call(this, this.stroke, "stroke", c), c.setAttribute("stroke-width", this["stroke-width"]), this.hasStroke = !0; else if (b === "stroke-width" && a === 0 && this.hasStroke)c.removeAttribute("stroke"), this.hasStroke = !1
    };
    var qa = function () {
    ...
    qa.prototype = {
        Element: Z, init: function (a, b, c, d, e, f) {
            ...
            if (Ua && a.getBoundingClientRect)this.subPixelFix = b = function () {
                ...
                G(a, {left: za(i.left) - i.left + "px", top: za(i.top) - i.top + "px"})
            }, b(), A(U, "resize", b)
        }, getStyle: function (a) {
            return this.style = w({
        ...
        destroy: function () {
            ...
            !f && !n && !q && e.indexOf(" ") === -1 ? b.appendChild(F.createTextNode(u(e))) : (h = /<.*style="([^"]+)".*>/,
                ...
                o(g, function (e) {
                    if (e !== "" || g.length === 1) {
                        var n = {}, r = F.createElementNS(Na, "tspan"), C;
                        h.test(e) && (C = e.match(h)[1].replace(/(;| |^)color([ :])/,
                            "$1fill$2"), X(r, "style", C));
                        i.test(e) && !d && (X(r, "onclick", 'location.href="' + e.match(i)[1] + '"'), G(r, {cursor: "pointer"}));
                        e = u(e.replace(/<(.|\n)*?>/g, "") || " ");
                        if (e !== " ") {
                            r.appendChild(F.createTextNode(e));
                            if (l)n.dx = 0; else if (f && k !== null)n.x = k;
                            X(r, n);
                            b.appendChild(r);
                            !l && f && (!ea && d && G(r, {display: "block"}), X(r, "dy", z(r)));
                            if (m) {
            ...
            var k = this.label(a, b, c, i, null, null, null, null, "button"), j = 0, m, l, n, q, r, C, a = {
                x1: 0,
                y1: 0,
                x2: 0,
                y2: 1
            ...
            n = e.style;
            delete e.style;
            f = B(e, {stroke: "#68A", fill: {linearGradient: a, stops: [[0, "#FFF"], [1, "#ACF"]]}}, f);
            q = f.style;
            delete f.style;
            ...
            if (h)g = this.path(h), w(g, {
                ...
                width: d,
                height: e
            }), f && w(g, f); else if (i.test(a))j = function (a, b) {
                a.element && (a.attr({
                    width: b[0],
                    height: b[1]
                ...
                x: b,
                y: c
            }), g.isImg = !0, a ? j(g, a) : (g.attr({width: 0, height: 0}), aa("img", {
                onload: function () {
                    this.width === 0 && (G(this, {
                        position: "absolute",
                        top: "-999em"
            ...
            diamond: function (a, b, c, d) {
                ...
                var f = e.start, c = e.r || c || d, g = e.end - 0.001, d = e.innerR, h = e.open, i = ba(f), k = ga(f), j = ba(g), g = ga(g), e = e.end - f < ua ? 0 : 1;
            ...
            function k() {
                ...
                if (A) {
                    ...
                    r.isImg || r.attr(w({width: x(n.width), height: x(n.height)}, hb));
                    hb = null
                }
            }

            function j() {
                var a = n.styles, a = a && a.textAlign, b = p + u * (1 - z), c;
                c = h ? 0 : D;
                if (t(L) && C && (a === "center" || a === "right"))b += {center: 0.5, right: 1}[a] * (L - C.width);
            ...
            var l = this, n = l.g(i), q = l.text("", 0, 0, g).attr({zIndex: 1}), r, C, z = 0, u = 3, p = 0, L, Ba, v, Jb, E = 0, hb = {}, D, A;
            n.onAdd = function () {
                q.add(n);
                n.attr({text: a || a === 0 ? a : "", x: b, y: c});
                r && t(e) && n.attr({anchorX: e, anchorY: f})
            };
            ...
            return w(n, {
                css: function (a) {
                    ...
                    return {width: C.width + 2 * u, height: C.height + 2 * u, x: C.x - u, y: C.y - u}
                }, shadow: function (a) {
                    r && r.shadow(a);
                    return n
                }, destroy: function () {
    ...
    w(Z.prototype, {
        htmlCss: function (a) {
            ...
            if (this.added) {
                ...
                if (b.tagName === "SPAN") {
                    var j = this.rotation, m, l = I(this.textWidth), n = [j, g, b.innerHTML, this.textWidth, this.textAlign].join(",");
                    if (n !== this.cTT) {
                        ...
                        if (i > l && /[ \-]/.test(b.textContent || b.innerText))G(b, {
                            width: l + "px", display: "block", whiteSpace: k &&
                            k.whiteSpace || "normal"
                        }), i = l;
            ...
            var d = {}, e = ya ? "-ms-transform" : ob ? "-webkit-transform" : Ua ? "MozTransform" : Tb ? "-o-transform" : "";
    ...
    if (!ea && !ma)M = {
        init: function (a, b) {
            ...
            var a = this.rotation, b = ba(a * pa), c = ga(a * pa);
            G(this.element, {filter: a ? ["progid:DXImageTransform.Microsoft.Matrix(M11=", b, ", M12=", -c, ", M21=", c, ", M22=", b, ", sizingMethod='auto expand')"].join("") : $})
        },
        getSpanCorrection: function (a, b, c, d, e) {
            var f = d ? ba(d * pa) : 1, g = d ? ga(d * pa) : 0, h = p(this.elemHeight, this.element.offsetHeight), i;
            this.xCorr = f < 0 && -a;
            this.yCorr = g < 0 && -h;
            i = f * g < 0;
            this.xCorr += g * b * (i ? 1 - c : c);
            this.yCorr -= f * b * (d ? i ? c : 1 - c : 1);
            e && e !== "left" && (this.xCorr -= a * c * (f < 0 ? -1 : 1), d && (this.yCorr -= h * c * (g < 0 ? -1 : 1)), G(this.element, {textAlign: e}))
        }, pathToVML: function (a) {
            for (var b = a.length, c = []; b--;)if (ra(a[b]))c[b] = x(a[b] * 10) - 5; else if (a[b] === "Z")c[b] = "x"; else if (c[b] = a[b], a.isArc && (a[b] === "wa" || a[b] === "at"))c[b + 5] ===
            ...
            var d = [], e, f = this.element, g = this.renderer, h, i = f.style, k, j = f.path, m, l, n, q;
            ...
            if (a) {
                ...
                for (e = 1; e <= 3; e++) {
                    ...
                    h = aa(g.prepVML(k), null, {left: I(i.left) + p(a.offsetX, 1), top: I(i.top) + p(a.offsetY, 1)});
                    if (c)h.cutOff = m + 1;
        ...
        Element: M, isIE8: Ga.indexOf("MSIE 8.0") > -1, init: function (a, b, c, d) {
            ...
            this.setSize(b, c, !1);
            if (!F.namespaces.hcv) {
                F.namespaces.add("hcv", "urn:schemas-microsoft-java:vml");
                try {
        ...
        isHidden: function () {
            ...
            var e = this.createElement(), f = ha(a);
            return w(e, {
                members: [],
                count: 0,
                left: (f ? a.x : a) + 1,
            ...
            if (i) {
                var j, m, l = a.linearGradient || a.radialGradient, n, q, r, C, p, u = "", a = a.stops, y, L = [], Ba = function () {
                ...
                if (c === "fill")if (i === "gradient")c = l.x1 || l[0] || 0, a = l.y1 || l[1] || 0, n = l.x2 || l[2] || 0, l = l.y2 || l[3] || 0, u = 'angle="' + (90 - Y.atan((l - a) / (n - c)) * 180 / ua) + '"', Ba(); else {
                    var k = l.r, s = k * 2, t = k * 2, v = l.cx, x = l.cy, w = b.radialReference, B, k = function () {
            ...
            } else if (g.test(a) && b.tagName !== "IMG")f = va(a), h = ["<", c, ' opacity="', f.get("a"), '"/>'], aa(this.prepVML(h), null, null, b), k = f.get("rgb"); else {
            ...
            b ? (a = a.replace("/>", ' xmlns="urn:schemas-microsoft-java:vml" />'), a = a.indexOf('style="') === -1 ? a.replace("/>",
            ...
            var b;
            a && (b = {
                className: "highcharts-" + a, "class": "highcharts-" +
                a
            });
            ...
            arc: function (a,
                           b, c, d, e) {
                var f = e.start, g = e.end, h = e.r || c || d, c = e.innerR, d = ba(f), i = ga(f), k = ba(g), j = ga(g);
                if (g - f === 0)return ["x"];
    ...
    Ya.prototype = {
        addLabel: function () {
            ...
            t(d) ? d && d.attr({text: b}) : (this.labelLength = (this.label =
            ...
            var b = this.axis, c = a.x, d = b.chart.chartWidth, e = b.chart.spacing, f = p(b.labelLeft, E(b.pos, e[3])), e = p(b.labelRight, v(b.pos + b.len, d - e[1])), g = this.label, h = this.rotation, i = {
                left: 0,
                center: 0.5,
                right: 1
            }[b.labelAlign], k = g.getBBox().width, j = b.slotWidth, m = 1, l, n =
            {};
            if (h)h < 0 && c - i * k < f ? l = x(c / ba(h * pa) - f) : h > 0 && c + i * k > e && (l = x((d - c) / ba(h * pa))); else if (d = c + (1 - i) * k, c - i * k < f ? j = a.x + j * (1 - i) - f : d > e && (j = e - a.x + j * i, m = -1), j = E(b.slotWidth, j), j < b.slotWidth && b.labelAlign === "center" && (a.x += m * (b.slotWidth - j - i * (b.slotWidth - E(k, j)))), k > j || b.autoRotation && g.styles.width)l = j;
            if (l) {
                n.width = l;
            ...
            var i = this.axis, k = i.transA, j = i.reversed, m = i.staggerLines, l = i.tickRotCorr || {
                    x: 0,
                    y: 0
                }, c = p(e.y, l.y + (i.side === 2 ? 8 : -(c.getBBox().height / 2))), a = a + e.x + l.x - (f && d ? f * k * (j ? -1 : 1) : 0), b = b + c - (f && !d ? f * k * (j ? 1 : -1) : 0);
            ...
            if (l && z)o === "inside" && (z = -z), d.opposite && (z = -z), h = this.getMarkPath(x, v, z, l * w, g, f), n ? n.animate({
                d: h,
                opacity: c
            }) : this.mark = f.path(h).attr({stroke: u, "stroke-width": l, opacity: c}).add(d.axisGroup);
            if (i && !isNaN(x))i.xy =
    ...
    D.PlotLineOrBand.prototype = {
        render: function () {
            var a =
                this, b = a.axis, c = b.horiz, d = a.options, e = d.label, f = a.label, g = d.width, h = d.to, i = d.from, k = t(i) && t(h), j = d.value, m = d.dashStyle, l = a.svgElem, n = [], q, r = d.color, C = d.zIndex, p = d.events, u = {}, o = b.chart.renderer;
            b.isLog && (i = Ka(i), h = Ka(h), j = Ka(j));
            if (g) {
                if (n = b.getPlotLinePath(j, g), u = {stroke: r, "stroke-width": g}, m)u.dashstyle = m
            } else if (k) {
            ...
            if (t(C))u.zIndex = C;
            if (l)if (n)l.animate({d: n}, null, l.onGetPath);
            else {
                if (l.hide(), l.onGetPath = function () {
                        l.show()
                    }, f)a.label = f = f.destroy()
            } else if (n && n.length && (a.svgElem = l = o.path(n).attr(u).add(), p))for (q in d = function (b) {
                l.on(b, function (c) {
                    p[b].apply(a, [c])
                })
            }, p)d(q);
            if (e && t(e.text) && n && n.length && b.width > 0 && b.height > 0) {
                ...
                if (!f) {
                    u = {align: e.textAlign || e.align, rotation: e.rotation};
                    if (t(C))u.zIndex = C;
                ...
                n = Ra(b);
                c = Ra(k);
                f.align(e, !1, {x: n, y: c, width: Fa(b) - n, height: Fa(k) - c});
                f.show()
            } else f && f.hide();
            return a
        }, destroy: function () {
    ...
    H.prototype = {
        ...
        defaultYAxisOptions: {
            ...
            stackLabels: {
                ...
                }, style: B(W.line.dataLabels.style, {color: "#000000"})
            }
        },
        ...
        defaultLabelFormatter: function () {
            ...
            if (h)g = La(h, this); else if (c)g = b; else if (d)g = ja(d, b); else if (f && a >= 1E3)for (; f-- && g === s;)c = Math.pow(1E3, f + 1), a >= c && b * 10 % c === 0 && e[f] !==
        ...
        getLinearTickPositions: function (a, b, c) {
            var d, e = la(T(b / a) * a), f = la(za(c / a) * a), g = [];
        ...
        adjustForMinRange: function () {
            var a =
                this.options, b = this.min, c = this.max, d, e = this.dataMax - this.dataMin >= this.minRange, f, g, h, i, k, j;
        ...
        setAxisTranslation: function (a) {
            ...
            if (j || i || d)if (h ? (f = h.minPointOffset, g = h.pointRangePadding) : o(b.series, function (a) {
                    var c = i ? 1 : j ? a.pointRange : b.axisPointRange || 0, h = a.options.pointPlacement, k = a.closestPointRange;
                    d = v(d, c);
        ...
        setTickInterval: function (a) {
            var b = this, c = b.chart, d = b.options, e = b.isLog, f = b.isDatetimeAxis, g = b.isXAxis, h = b.isLinked, i = d.maxPadding, k = d.minPadding, j = d.tickInterval, m = d.tickPixelInterval, l = b.categories, n = b.threshold, q = b.softThreshold,
                r, C, z, u;
            ...
            if (q && t(b.dataMin))if (n = n || 0, !t(z) && b.min < n && b.dataMin >= n)b.min = n; else if (!t(u) && b.max > n && b.dataMax <= n)b.max = n;
        ...
        getTickAmount: function () {
            var a =
            {}, b, c = this.options, d = c.tickAmount, e = c.tickPixelInterval;
        ...
        adjustTickAmount: function () {
            var a = this.tickInterval, b =
                this.tickPositions, c = this.tickAmount, d = this.finalTickAmt, e = b && b.length;
            if (e < c) {
        ...
        setAxisSize: function () {
            var a = this.chart, b = this.options, c = b.offsetLeft || 0, d = this.horiz, e = p(b.width, a.plotWidth - c + (b.offsetRight || 0)), f = p(b.height,
                a.plotHeight), g = p(b.top, a.plotTop), b = p(b.left, a.plotLeft + c), c = /%$/;
        ...
        renderUnsquish: function () {
            var a = this.chart, b = a.renderer, c = this.tickPositions, d = this.ticks, e = this.options.labels, f = this.horiz, g = a.margin, h = this.categories ?
                c.length : c.length - 1, i = this.slotWidth = f && !e.step && !e.rotation && (this.staggerLines || 1) * a.plotWidth / h || !f && (g[3] && g[3] - a.spacing[3] || a.chartWidth * 0.33), k = v(1, x(i - 2 * (e.padding || 5))), j = {}, g = b.fontMetrics(e.style.fontSize, d[0] && d[0].label), h = e.style.textOverflow, m, l = 0;
            if (!Ia(e.rotation))j.rotation = e.rotation || 0;
            if (this.autoRotation)o(c, function (a) {
                if ((a = d[a]) && a.labelLength > l)l = a.labelLength
            }), l > k && l > g.h ? j.rotation = this.labelRotation : this.labelRotation = 0; else if (i && (m = {width: k + "px"}, !h)) {
                m.textOverflow =
                    "clip";
                for (i = c.length; !f && i--;)if (k = c[i], k = d[k].label)if (k.styles.textOverflow === "ellipsis" && k.css({textOverflow: "clip"}), k.getBBox().height > this.len / c.length - (g.h - g.f))k.specCss = {textOverflow: "ellipsis"}
            }
            if (j.rotation && (m = {width: (l > a.chartHeight * 0.5 ? a.chartHeight * 0.33 : a.chartHeight) + "px"}, !h))m.textOverflow = "ellipsis";
        ...
        getOffset: function () {
            var a = this, b = a.chart, c = b.renderer, d = a.options, e = a.tickPositions, f = a.ticks, g = a.horiz, h = a.side, i = b.inverted ? [1, 0, 3, 2][h] : h, k, j, m = 0, l, n = 0, q = d.title, r = d.labels, C = 0, z = b.axisOffset, b = b.clipOffset, u = [-1, 1, 1, -1][h], y, L = a.axisParent;
            k = a.hasData();
            a.showAxis = j = k || p(d.showEmpty, !0);
            a.staggerLines = a.horiz && r.staggerLines;
            if (!a.axisGroup)a.gridGroup = c.g("grid").attr({zIndex: d.gridZIndex || 1}).add(L), a.axisGroup = c.g("axis").attr({zIndex: d.zIndex || 2}).add(L), a.labelGroup = c.g("axis-labels").attr({zIndex: r.zIndex || 7}).addClass("highcharts-" + a.coll.toLowerCase() + "-labels").add(L);
            if (k || a.isLinked) {
                if (o(e, function (b) {
        ...
        getTitlePosition: function () {
            var a = this.horiz, b = this.left, c = this.top, d = this.len, e = this.options.title, f = a ? b : c, g = this.opposite, h = this.offset, i = e.x || 0, k = e.y || 0, j = I(e.style.fontSize || 12), d = {
                low: f + (a ? 0 : d),
                middle: f + d / 2,
                high: f + (a ? d : 0)
        ...
        render: function () {
            var a = this, b = a.chart, c = b.renderer, d = a.options, e = a.isLog, f = a.isLinked, g = a.tickPositions,
                h = a.axisTitle, i = a.ticks, k = a.minorTicks, j = a.alternateBands, m = d.stackLabels, l = d.alternateGridColor, n = a.tickmarkOffset, q = d.lineWidth, r, C = b.hasRendered && t(a.oldMin) && !isNaN(a.oldMin), p = a.showAxis, u = c.globalAnimation, y, L;
            ...
            o([i, k, j], function (a) {
                var c, d, e = [], f = u ? u.duration || 500 : 0, g = function () {
    ...
    w(H.prototype, {
        getPlotBandPath: function (a, b) {
            ...
            var c = (new D.PlotLineOrBand(this, a)).render(), d = this.userOptions;
    ...
    H.prototype.getTimeTicks = function (a, b, c, d) {
        var e = [], f = {}, g = N.global.useUTC, h, i = new fa(b - ab(b)), k = a.unitRange, j = a.count;
        if (t(b)) {
        ...
        e.info = w(a, {higherRanks: f, totalRange: k * j});
        return e
    };
    H.prototype.normalizeTimeTickInterval = function (a, b) {
        var c = b || [["millisecond", [1, 2, 5, 10, 20, 25, 50, 100, 200, 500]], ["second", [1, 2, 5, 10, 15, 30]], ["minute", [1, 2, 5, 10, 15, 30]], ["hour", [1, 2, 3, 4, 6, 8, 12]], ["day", [1, 2]], ["week", [1, 2]], ["month", [1, 2, 3, 4, 6]], ["year", null]], d = c[c.length - 1], e = J[d[0]], f = d[1], g;
        for (g = 0; g < c.length; g++)if (d = c[g], e = J[d[0]], f = d[1], c[g + 1] && a <= (e * f[f.length - 1] + J[c[g + 1][0]]) /
            2)break;
    ...
    H.prototype.getLogTickPositions = function (a, b, c, d) {
        ...
        if (a >= 0.5)a = x(a), g = this.getLinearTickPositions(a, b, c); else if (a >= 0.08)for (var f = T(b), h, i, k, j, m, e = a > 0.3 ? [1, 2, 4] : a > 0.15 ? [1, 2, 4, 6, 8] : [1, 2, 3, 4, 5, 6, 7, 8, 9]; f < c + 1 && !m; f++) {
            i = e.length;
    ...
    Kb.prototype = {
        init: function (a, b) {
            ...
            var c,
                d = this.chart, e = d.inverted, f = d.plotTop, g = d.plotLeft, h = 0, i = 0, k, j, a = na(a);
            c = a[0].tooltipPos;
            ...
            var d = this.chart,
                e = this.distance, f = {}, g = c.h || 0, h, i = ["y", d.chartHeight, b, c.plotY + d.plotTop, d.plotTop, d.plotTop + d.plotHeight], k = ["x", d.chartWidth, a, c.plotX + d.plotLeft, d.plotLeft, d.plotLeft + d.plotWidth], j = p(c.ttBelow, d.inverted && !c.negative || !d.inverted && c.negative), m = function (a, b, c, d, h, i) {
                    var k = c < d - e, l = d + e + c < b, m = d - e - c;
                    d += e;
                    if (j && l)f[a] = d; else if (!j && k)f[a] = m; else if (k)f[a] = E(i - c, m - g < 0 ? m : m - g); else if (l)f[a] = v(h, d + g + c > b ? d : d + g); else return !1
                }, l = function (a, b, c, d) {
            ...
            ($a(d), d.attr("opacity", 1).show()), d.attr({text: k}), m = e.borderColor || a.color || i.color || "#606060", d.attr({stroke: m}), this.updatePosition({
                plotX: f,
                plotY: g,
                negative: a.negative,
                ttBelow: a.ttBelow,
            ...
            O(c, "tooltipRefresh", {text: k, x: f + c.plotLeft, y: g + c.plotTop, borderColor: m})
            ...
            var c = b ? "footer" : "header",
                d = a.series, e = d.tooltipOptions, f = e.xDateFormat, g = d.xAxis, h = g && g.options.type === "datetime" && ra(a.key), c = e[c + "Format"];
    ...
    Wa.prototype =
    {
        ...
        return w(a, {chartX: x(c), chartY: x(d)})
        ...
        var b = this.chart, c = b.series, d = b.tooltip,
            e = d ? d.shared : !1, f = b.hoverPoint, g = b.hoverSeries, h, i = Number.MAX_VALUE, k, j, m = [], l, n;
        ...
        var b = this.chart, c = b.options.chart, d = a.chartX, e = a.chartY, f = this.zoomHor, g = this.zoomVert, h = b.plotLeft, i = b.plotTop, k = b.plotWidth, j = b.plotHeight, m, l = this.selectionMarker, n = this.mouseDownX, q = this.mouseDownY, r = c.panKey && a[c.panKey + "Key"];
        if (!l || !l.touch)if (d < h ? d = h : d > h + k && (d = h + k), e < i ? e = i : e > i + j && (e = i + j), this.hasDragged = Math.sqrt(Math.pow(n - d, 2) + Math.pow(q - e, 2)), this.hasDragged >
            10) {
            ...
            l && f && (d -= n, l.attr({width: Q(d), x: (d > 0 ? 0 : d) + n}));
            l && g && (d = e - q, l.attr({height: Q(d), y: (d > 0 ? 0 : d) + q}));
        ...
        if (this.selectionMarker) {
            ...
            if (this.hasDragged || d)o(c.axes, function (c) {
                if (c.zoomEnabled && t(c.min) && (d || b[{xAxis: "zoomX", yAxis: "zoomY"}[c.coll]])) {
                    var f = c.horiz, n = a.type === "touchend" ? c.minPixelPadding : 0, q = c.toValue((f ? g : h) + n), f = c.toValue((f ? g + i : h + k) - n);
                    e[c.coll].push({axis: c, min: E(q, f), max: v(q, f)});
                    j = !0
                }
    ...
    w(D.Pointer.prototype, {
        pinchTranslate: function (a, b, c, d, e, f) {
            ...
            var i = this.chart, k = a ? "x" : "y", j = a ? "X" : "Y", m = "chart" + j, l = a ? "width" : "height", n = i["plot" + (a ? "Left" : "Top")], q, r, C = h || 1, p = i.inverted, o = i.bounds[a ? "h" : "v"], y = b.length === 1, L = b[0][m], s = c[0][m], v = !y && b[1][m], t = !y && c[1][m], x, c = function () {
            ...
            if (a.type === "touchstart")o(e, function (a,
                ...
                if (!i)b.selectionMarker = i = w({destroy: ka, touch: !0}, c.plotBox);
    ...
    if (U.PointerEvent || U.MSPointerEvent) {
        var Ca = {}, Lb = !!U.PointerEvent, gc = function () {
            var a, b = [];
            b.item = function (a) {
                return this[a]
            };
            for (a in Ca)Ca.hasOwnProperty(a) && b.push({pageX: Ca[a].pageX, pageY: Ca[a].pageY, target: Ca[a].target});
            return b
        }, Mb = function (a, b, c, d) {
            a = a.originalEvent || a;
            ...
            onContainerPointerDown: function (a) {
                Mb(a,
                    "onContainerTouchStart", "touchstart", function (a) {
                        Ca[a.pointerId] = {pageX: a.pageX, pageY: a.pageY, target: a.currentTarget}
                    })
            }, onContainerPointerMove: function (a) {
                Mb(a, "onContainerTouchMove", "touchmove", function (a) {
                    Ca[a.pointerId] = {pageX: a.pageX, pageY: a.pageY};
        ...
        R(Wa.prototype, "init", function (a, b, c) {
            a.call(this, b, c);
            this.hasZoom && G(b.container, {"-ms-touch-action": $, "touch-action": $})
        });
    ...
    sb.prototype = {
        init: function (a, b) {
            ...
            var c = this.options, d = a.legendItem, e =
                a.legendLine, f = a.legendSymbol, g = this.itemHiddenStyle.color, c = b ? c.itemStyle.color : g, h = b ? a.legendColor || a.color || "#CCC" : g, g = a.options && a.options.marker, i = {fill: h}, k;
            ...
            if (b)c = b.translateY, o(this.allItems, function (e) {
                ...
                f && (g = c + f.y + (a || 0) + 3, G(f, {
                    ...
                    f.x - 20 + "px", top: g + "px", display: g > c - 6 && g < c + d - 6 ? "" : $
                }))
            })
            ...
            var b = this.chart, c = b.renderer, d = this.options, e = d.layout === "horizontal", f = this.symbolWidth, g = d.symbolPadding, h = this.itemStyle, i = this.itemHiddenStyle, k = this.padding, j = e ? p(d.itemDistance, 20) : 0, m = !d.rtl, l = d.width, n = d.itemMarginBottom || 0, q = this.itemMarginTop, r = this.initialItemX, C = a.legendItem, o = a.series && a.series.drawLegendSymbol ? a.series : a, u = o.options, u = this.createCheckboxForItem && u && u.showCheckbox, y = d.useHTML;
            if (!C) {
            ...
            f && d.align(w({width: g, height: h}, k), !0, "spacingBox");
            b.isResizing || this.positionCheckboxes()
        }, handleOverflow: function (a) {
            var b = this, c = this.chart, d = c.renderer, e = this.options, f = e.y, f = c.spacingBox.height + (e.verticalAlign === "top" ? -f : f) - this.padding, g = e.maxHeight, h, i = this.clipRect, k = e.navigation, j = p(k.animation, !0), m = k.arrowSize || 12, l = this.nav, n = this.pages, q = this.padding, r, C = this.allItems, z = function (a) {
                i.attr({height: a});
            ...
            if (a > f) {
                ...
                this.fullHeight = a;
                o(C, function (a, b) {
                    var c = a._legendItemPos[1], d = x(a.legendItem.getBBox().height), e = n.length;
                ...
                z(h);
                if (!l)this.nav = l = d.g().attr({zIndex: 1}).add(this.group),
                ...
                b.scroll(0);
                a = f
            } else if (l)z(c.chartHeight), l.hide(), this.scrollGroup.attr({translateY: 1}), this.clipHeight = 0;
            return a
        }, scroll: function (a, b) {
    ...
    Ha.prototype = {
        callbacks: [], init: function (a, b) {
            ...
            (b = K[a.type || b.type || b.defaultSeriesType]) || oa(17,
                !0);
            b = new b;
            b.init(this, a);
            return b
            ...
            var b = this.axes, c = this.series, d = this.pointer, e = this.legend, f = this.isDirtyLegend, g, h, i = this.hasCartesianSeries, k = this.isDirtyBox, j = c.length, m = j, l = this.renderer, n = l.isHidden(), q = [];
            Xa(a, this);
            ...
            d && (d.css({width: (e.width || h) + "px"}).align(w({y: b + (f.margin - 13) + g.fontMetrics(e.style.fontSize, c).b}, e), !1, "spacingBox"), !e.floating && !e.verticalAlign && (b = za(b + d.getBBox().height)));
            ...
            var b = this, c = b.options.chart, d = b.renderTo, e = c.width || qb(d, "width"), f = c.height || qb(d, "height"), c = a ? a.target : U, d = function () {
            ...
            a = h.globalAnimation;
            (a ? rb : G)(d.container, {width: e + "px", height: f + "px"}, a);
            d.setChartSize(!0);
            h.setSize(e, f, c);
            d.maxTicks = null;
            o(d.axes, function (a) {
            ...
            if (j)f ? f.animate(u) : this.plotBackground = b.rect(q, r, p, o, 0).attr({fill: j}).add().shadow(a.plotShadow);
            if (m)h ? h.animate(u) : this.plotBGImage = b.image(m, q, r, p, o).add();
            y ? y.animate({width: s.width, height: s.height}) : this.clipRect =
                b.clipRect(s);
            ...
            b.items && o(b.items, function (c) {
                var d = w(b.style, c.style), e = I(d.left) + a.plotLeft, f = I(d.top) + a.plotTop + 12;
                delete d.left;
                delete d.top;
    ...
    Da.prototype = {
        init: function (a, b, c) {
            ...
            var c = this.series, d = c.options.pointValKey || c.pointValKey, a = Da.prototype.optionsToObject.call(this, a);
            w(this, a);
    ...
    P.prototype = {
        ...
        init: function (a, b) {
            ...
            c.linkedSeries =
                [];
            c.bindAxes();
            w(c, {name: b.name, state: "", pointAttr: {}, visible: b.visible !== !1, selected: b.selected === !0});
            if (ma)b.animation = !1;
            e = b.events;
        ...
        setData: function (a, b, c, d) {
            var e = this, f = e.points, g = f && f.length || 0, h, i = e.options, k = e.chart, j = null, m = e.xAxis, l = m && !!m.categories, n = i.turboThreshold, q = this.xData, r = this.yData, C = (h = e.pointArrayMap) && h.length, a = a || [];
            h = a.length;
            b = p(b, !0);
            if (d !== !1 && h && g === h && !e.cropped && !e.hasGroupedData && e.visible)o(a, function (a, b) {
                ...
                if (n && h > n) {
                    ...
                    if (ra(j)) {
                        ...
                        e.xIncrement = l
                    } else if (Ja(j))if (C)for (c = 0; c < h; c++)j = a[c], q[c] = j[0], r[c] = j.slice(1, C + 1); else for (c = 0; c < h; c++)j = a[c], q[c] = j[0], r[c] = j[1]; else oa(12)
                } else for (c =
        ...
        processData: function (a) {
            ...
            e = 0;
            var f, g, h = this.xAxis, i, k =
                this.options;
            i = k.cropThreshold;
            var j = this.getExtremesFromAll || k.getExtremesFromAll, m = this.isCartesian, l, n;
            if (m && !this.isDirty && !h.isDirty && !this.yAxis.isDirty && !a)return !1;
            if (h)a = h.getExtremes(), l = a.min, n = a.max;
            if (m && this.sorted && !j && (!i || d > i || this.forceCrop))if (b[d - 1] < l || b[0] > n)b = [], c = []; else if (b[0] < l || b[d - 1] > n)e = this.cropData(this.xData, this.yData, l, n), b = e.xData, c = e.yData, e = e.start, f = !0;
        ...
        drawPoints: function () {
            var a, b = this.points, c = this.chart, d, e, f, g, h, i, k, j, m = this.options.marker,
                l = this.pointAttr[""], n, q, r, o = this.markerGroup, z = p(m.enabled, this.xAxis.isRadial, this.closestPointRangePx > 2 * m.radius);
            if (m.enabled !== !1 || this._hasPointMarkers)for (f = b.length; f--;)if (g = b[f], d = T(g.plotX), e = g.plotY, j = g.graphic, n = g.marker || {}, q = !!g.marker, a = z && n.enabled === s || n.enabled, r = g.isInside, a && e !== s && !isNaN(e) && g.y !== null)if (a = g.pointAttr[g.selected ? "select" : ""] || l, h = a.r, i = p(n.symbol, this.symbol), k = i.indexOf("url") === 0, j)j[r ? "show" : "hide"](!0).animate(w({
                x: d - h,
                y: e - h
            }, j.symbolName ? {
                width: 2 * h, height: 2 *
        ...
        getAttribs: function () {
            var a = this, b = a.options, c = W[a.type].marker ? b.marker : b, d = c.states, e = d.hover, f, g = a.color, h = a.options.negativeColor;
            f = {stroke: g, fill: g};
            var i = a.points || [], k, j, m = [], l = a.pointAttrToOptions;
            k = a.hasPointSpecificOptions;
            var n = c.lineColor, q = c.fillColor;
            j = b.turboThreshold;
            var r = a.zones, C = a.zoneAxis || "y", z;
            ...
            if (!j || g < j || k)for (; g--;) {
                ...
                if (j.options)for (z in l)t(c[l[z]]) && (k = !0);
                if (k) {
                    c = c || {};
                    k = [];
                    d = c.states || {};
        ...
        destroy: function () {
            var a = this, b = a.chart, c = /AppleWebKit\/533/.test(Ga), d, e = a.data || [], f, g, h;
            O(a, "destroy");
            V(a);
        ...
        drawGraph: function () {
            var a = this, b = this.options, c = [["graph", b.lineColor || this.color, b.dashStyle]], d = b.lineWidth, e = b.linecap !== "square", f = this.getGraphPath(), g = this.fillGraph && this.color || $;
        ...
        applyZones: function () {
            var a = this, b = this.chart, c = b.renderer, d = this.zones, e, f, g = this.clips || [], h, i = this.graph, k = this.area, j = v(b.chartWidth, b.chartHeight), m = this[(this.zoneAxis ||
            "y") + "Axis"], l, n = m.reversed, q = b.inverted, r = m.horiz, C, z, u, y = !1;
            if (d.length && (i || k) && m.min !== s)i && i.hide(), k && k.hide(), l = m.getExtremes(), o(d, function (d, o) {
                ...
                u = v(e, f);
                if (m.isXAxis) {
                    if (h = {x: q ? u : z, y: 0, width: C, height: j}, !r)h.x = b.plotHeight - h.x
                } else if (h = {x: 0, y: q ? u : z, width: j, height: C}, r)h.y = b.plotWidth - h.y;
                b.inverted && c.isVML && (h = m.isXAxis ? {
                    x: 0, y: n ?
                        z : u, height: h.width, width: b.chartWidth
        ...
        render: function () {
            var a = this, b = a.chart, c, d = a.options, e = (c = d.animation) && !!a.animate && b.renderer.isSVG &&
                p(c.duration, 500) || 0, f = a.visible ? "visible" : "hidden", g = d.zIndex, h = a.hasRendered, i = b.seriesGroup;
        ...
        searchKDTree: function (a, b) {
            function c(a, b, k, j) {
                var m = b.point, l = d.kdAxisArray[k % j], n, q, r = m;
    ...
    P.prototype.setStackedPoints = function () {
        if (this.options.stacking && !(this.visible !== !0 && this.chart.options.chart.ignoreHiddenSeries !== !1)) {
            var a = this.processedXData, b = this.processedYData, c = [], d = b.length, e = this.options, f = e.threshold, g = e.startFromThreshold ? f : 0, h = e.stack, e = e.stacking, i = this.stackKey,
                k = "-" + i, j = this.negStacks, m = this.yAxis, l = m.stacks, n = m.oldStacks, q, r, o, z, u, y, s;
            m.stacksTouched += 1;
            for (u = 0; u < d; u++) {
                y = a[u];
                s = b[u];
    ...
    P.prototype.setPercentStacks = function () {
        ...
        o([b, "-" + b], function (b) {
            var f;
            for (var g = d.length, h, i; g--;)if (h = d[g], e = a.getStackIndicator(e, h, a.index), f = (i = c[b] && c[b][h]) && i.points[e.key], h = f)i = i.total ? 100 / i.total : 0, h[0] = la(h[0] * i), h[1] = la(h[1] * i), a.stackedYData[g] = h[1]
        })
    };
    P.prototype.getStackIndicator =
        function (a, b, c) {
            !t(a) || a.x !== b ? a = {x: b, index: 0} : a.index++;
    ...
    w(Ha.prototype, {
        addSeries: function (a, b, c) {
            var d, e = this;
            a && (b = p(b, !0), O(e, "addSeries", {options: a}, function () {
                d = e.initSeries(a);
                e.isDirtyLegend = !0;
                e.linkSeries();
                b && e.redraw(c)
            ...
            new H(this, B(a, {index: this[e].length, isX: b}));
            f[e] = na(f[e] || {});
            f[e].push(a);
            p(c, !0) && this.redraw(d)
        }, showLoading: function (a) {
            var b = this, c = b.options, d =
                b.loadingDiv, e = c.loading, f = function () {
                d && G(d, {
                    left: b.plotLeft + "px",
                    top: b.plotTop + "px",
            ...
            if (!d)b.loadingDiv = d = aa(Ta, {className: "highcharts-loading"}, w(e.style, {
                zIndex: 10,
                display: $
    ...
    w(P.prototype, {
        addPoint: function (a, b, c, d) {
            var e = this, f = e.options, g = e.data, h = e.graph, i = e.area, k = e.chart, j = e.xAxis &&
                e.xAxis.names, m = h && h.shift || 0, l = ["graph", "area"], h = f.data, n, q = e.xData;
            Xa(d, k);
            if (c) {
            ...
            l = i.x;
            d = q.length;
            if (e.requireSorting && l < q[d - 1])for (n = !0; d && q[d - 1] > l;)d--;
            ...
            var c = this, d = this.chart, e = this.userOptions, f = this.type, g = K[f].prototype, h = ["group", "markerGroup", "dataLabelsGroup"], i;
            if (a.type && a.type !== f || a.zIndex !== void 0)h.length = 0;
            o(h, function (a) {
                h[a] = c[a];
                delete c[a]
            });
            a = B(e, {animation: !1, index: this.index, pointStart: this.xData[0]},
    ...
    var Ea = ia(P);
    K.line = Ea;
    W.area = B(S, {softThreshold: !1, threshold: 0});
    var xa = ia(P, {
        type: "area", getSegments: function () {
            var a = this, b = [], c = [], d = [], e = this.xAxis, f = this.yAxis, g = f.stacks[this.stackKey], h = {}, i, k, j = this.points,
                m = this.options.connectNulls, l, n, q;
    ...
    Ea = ia(P, {
        ...
        getColumnMetrics: function () {
            var a =
                this, b = a.options, c = a.xAxis, d = a.yAxis, e = c.reversed, f, g = {}, h, i = 0;
            ...
            var k = E(Q(c.transA) * (c.ordinalSlope || b.pointRange || c.closestPointRange || c.tickInterval || 1), c.len), j = k * b.groupPadding, m = (k - 2 * j) / i, b = E(b.maxPointWidth || c.len, p(b.pointWidth, m * (1 - 2 * b.pointPadding)));
        ...
        translate: function () {
            var a = this, b = a.chart, c = a.options, d = a.borderWidth = p(c.borderWidth, a.closestPointRange * a.xAxis.transA < 2 ? 0 : 1), e = a.yAxis,
                f = a.translatedThreshold = e.getThreshold(c.threshold), g = p(c.minPointLength, 5), h = a.getColumnMetrics(), i = h.width, k = a.barW = v(i, 1 + 2 * d), j = a.pointXOffset = h.offset;
            b.inverted && (f -= 0.5);
            c.pointPadding && (k = za(k));
            P.prototype.translate.apply(a);
            o(a.points, function (c) {
                var d = E(p(c.yBottom, f), 9E4), h = 999 + Q(d), h = E(v(-h, c.plotY), e.len + h), q = c.plotX + j, r = k, o = E(h, d), z, u = v(h, d) - o;
                Q(u) < g && g && (u = g, z = !e.reversed && !c.negative || e.reversed && c.negative, o = Q(o - f) > g ? d - g : f - (z ? g : 0));
                c.barX = q;
                c.pointWidth = i;
                c.tooltipPos = b.inverted ?
                    [e.len + e.pos - b.plotLeft - h, a.xAxis.len - q - r / 2, u] : [q + r / 2, h + e.pos - b.plotTop, u];
                c.shapeType = "rect";
        ...
        drawPoints: function () {
            ...
            o(a.points, function (h) {
                ...
                if (i !== s && !isNaN(i) && h.y !== null)f = h.shapeArgs, i = t(a.borderWidth) ? {"stroke-width": a.borderWidth} : {}, g = h.pointAttr[h.selected ? "select" : ""] || a.pointAttr[""], k ? ($a(k), k.attr(i)[b.pointCount <
                e ? "animate" : "attr"](B(f))) : h.graphic = d[h.shapeType](f).attr(i).attr(g).add(h.group || a.group).shadow(c.shadow, null, c.stacking && !c.borderRadius); else if (k)h.graphic = k.destroy()
            })
        },
        animate: function (a) {
    ...
    S = {
        ...
        translate: function (a) {
            this.generatePoints();
            var b = 0, c = this.options, d = c.slicedOffset, e = d + c.borderWidth, f, g, h, i = c.startAngle || 0, k = this.startAngleRad = ua / 180 * (i - 90), i = (this.endAngleRad = ua / 180 * (p(c.endAngle, i + 360) - 90)) - k, j = this.points, m = c.dataLabels.distance, c = c.ignoreHiddenPoint, l, n = j.length, q;
            ...
            for (l = 0; l < n; l++) {
                ...
                q.shapeArgs = {
                    x: a[0], y: a[1],
                    r: a[2] / 2, innerR: a[3] / 2, start: x(f * 1E3) / 1E3, end: x(g * 1E3) / 1E3
                };
                h = (g + f) / 2;
                h > 1.5 * ua ? h -= 2 * ua : h < -ua / 2 && (h += 2 * ua);
                q.slicedTranslation = {translateX: x(ba(h) * d), translateY: x(ga(h) * d)};
                f = ba(h) * a[2] / 2;
                g = ga(h) * a[2] / 2;
        ...
        drawPoints: function () {
            ...
            o(a.points, function (i) {
                if (i.y !== null) {
                    ...
                    f && f.attr(c);
                    if (d)d.setRadialReference(a.center).animate(w(g, c)); else {
    ...
    P.prototype.drawDataLabels = function () {
        ...
        6), p(d.defer, !0) && (k.attr({opacity: +h}), h || A(a, "afterAnimate", function () {
            a.visible && k.show();
            k[b.animation ? "animate" : "attr"]({opacity: 1}, {duration: 200})
        })), g = d, o(e, function (e) {
            var h, n = e.dataLabel, q, r, o = e.connector, z = !0, u, y = {};
    ...
    P.prototype.alignDataLabel = function (a, b, c, d, e) {
        var f = this.chart, g = f.inverted, h = p(a.plotX, -999), i = p(a.plotY, -999), k = b.getBBox(), j = f.renderer.fontMetrics(c.style.fontSize).b, m = this.visible && (a.series.forceDL || f.isInsidePlot(h, x(i), g) || d && f.isInsidePlot(h, g ? d.x + 1 : d.y + d.height - 1, g));
        if (m)d = w({
            x: g ? f.plotWidth - i : h,
    ...
    if (K.pie)K.pie.prototype.drawDataLabels = function () {
        var a = this, b = a.data, c, d = a.chart, e = a.options.dataLabels, f = p(e.connectorPadding, 10), g = p(e.connectorWidth, 1), h = d.plotWidth, i = d.plotHeight, k, j, m = p(e.softConnector, !0), l = e.distance,
            n = a.center, q = n[2] / 2, r = n[1], C = l > 0, z, u, y, s = [[], []], t, w, B, D, A, F = [0, 0, 0, 0], K = function (a, b) {
                return b.y - a.y
            };
        if (a.visible && (e.enabled || a._hasPointLabels)) {
                ...
                if (G) {
                    ...
                    if (l > 0) {
                        ...
                        for (A = 0; A < G; A++) {
                            ...
                            if (J < A && I[A] !== null)J = A; else for (u < G - A + J && I[A] !== null && (J = u - G + A); I[J] === null;)J++;
                            M.push({i: J, y: I[J]});
                            I[J] = null
                        }
                        M.sort(K)
                    ...
                    for (A = 0; A < G; A++) {
                        ...
                        z._attr = {visibility: B, align: y[6]};
                        z._pos = {x: t + e.x + ({left: f, right: -f}[y[6]] || 0), y: w + e.y - 10};
                        z.connX = t;
                        z.connY = w;
            ...
            if (Fa(F) === 0 || this.verifyDataLabelOverflow(F))this.placeDataLabels(), C && g && o(this.points, function (b) {
                ...
                if ((z = b.dataLabel) && z._pos &&
                    b.visible)B = z._attr.visibility, t = z.connX, w = z.connY, j = m ? ["M", t + (y[6] === "left" ? 5 : -5), w, "C", t, w, 2 * y[2] - y[4], 2 * y[3] - y[5], y[2], y[3], "L", y[4], y[5]] : ["M", t + (y[6] === "left" ? 5 : -5), w, "L", y[2], y[3], "L", y[4], y[5]], k ? (k.animate({d: j}), k.attr("visibility", B)) : b.connector = k = a.chart.renderer.path(j).attr({
                    "stroke-width": g,
    ...
    (function (a) {
        ...
        b.prototype.hideOverlappingLabels = function (a) {
            ...
            for (e = 0; e < b; e++) {
                k = a[e];
                for (d = e + 1; d < b; ++d)if (j = a[d], k && j && k.placed && j.placed &&
    ...
    var jb = D.TrackerMixin = {
        drawTrackerPoint: function () {
            var a = this, b = a.chart, c = b.pointer,
                d = a.options.cursor, e = d && {cursor: d}, f = function (a) {
            ...
            var a =
                this, b = a.options, c = b.trackByArea, d = [].concat(c ? a.areaPath : a.graphPath), e = d.length, f = a.chart, g = f.pointer, h = f.renderer, i = f.options.tooltip.snap, k = a.tracker, j = b.cursor, m = j && {cursor: j}, j = a.singlePoints, l, n = function () {
    ...
    w(sb.prototype, {
        setItemEvents: function (a, b, c, d, e) {
            ...
            a.checkbox = aa("input", {
                type: "checkbox", checked: a.selected,
    ...
    w(Ha.prototype, {
        showResetZoom: function () {
            ...
            if (d && !e)this.showResetZoom(); else if (!d && ha(e))this.resetZoomButton = e.destroy();
            ...
            o(b === "xy" ? [1, 0] : [1], function (b) {
                ...
                if (h.series.length && (i || m > E(j.dataMin, j.min)) && (!i || k < v(j.dataMax, j.max)))h.setExtremes(m, k, !1,
                    !1, {trigger: "pan"}), e = !0;
    ...
    w(Da.prototype, {
        select: function (a, b) {
            ...
            var c = T(this.plotX), d = this.plotY, e = this.series, f = e.options.states, g = W[e.type].marker && e.options.marker, h = g && !g.enabled, i = g && g.states[a], k = i && i.enabled === !1, j = e.stateMarkerGraphic, m = this.marker || {}, l = e.chart, n = e.halo, q, a = a || "";
            ...
            if (!(a === this.state && !b || this.selected && a !== "select" || f[a] && f[a].enabled === !1 || a && (k || h && i.enabled === !1) || a && m.states && m.states[a] && m.states[a].enabled === !1)) {
                ...
                if ((c =
                    ...
                    n.attr(w({fill: va(this.color || e.color).setOpacity(c.opacity).get()}, c.attributes))[b ? "animate" : "attr"]({d: this.haloPath(c.size)})
                } else n && n.attr({d: []});
                this.state = a
            }
        }, haloPath: function (a) {
    ...
    R(H.prototype, "getTimeTicks", function (a, b, c, d, e, f, g, h) {
        var i = 0, k = 0, j, m = {}, l, n, q, r = [], o = -Number.MAX_VALUE, p = this.options.tickPixelInterval;
    ...
    w(H.prototype, {
        beforeSetTickPositions: function () {
            ...
            if (c) {
                ...
                if (b)a < 0 ? a = c[0] : a > f ? a = c[f] : (f = T(a), h = a - f); else for (; f--;)if (g = d * f + e, a >= g) {
                    d = d * (f + 1) + e;
                    h = (a - g) / (d - g);
                    break
                }
            ...
            if (!c[d])f = {
                ...
                }, options: {ordinal: !0}, val2lin: H.prototype.val2lin
    ...
    R(Ha.prototype, "pan", function (a, b) {
        ...
        if (c.options.ordinal && c.series.length) {
            var f = this.mouseDownX, g = c.getExtremes(), h = g.dataMax, i = g.min, k = g.max, j = this.hoverPoints, m = c.closestPointRange, f = (f - d) / (c.translationSlope * (c.ordinalSlope || m)), l = {ordinalPositions: c.getExtendedPositions()}, m = c.lin2val, n = c.val2lin, q;
    ...
    (function (a) {
        ...
        d(g.prototype, "init", function (a, b, c) {
            ...
            if (this.options.breaks) {
                ...
                this.lin2val = function (a) {
                    var b, c;
                    for (c = 0; c < d.breakArray.length; c++)if (b = d.breakArray[c], b.from >= a)break; else b.to < a ? a += b.len : d.isInBreak(b, a) && (a += b.len);
                    return a
                };
                ...
                this.setAxisTranslation = function (a) {
                    ...
                    var b = d.options.breaks, a = [], c = [], e = 0, h, i, j = d.userMin || d.min, k = d.userMax || d.max, o, p;
                    ...
                    for (p in b) {
                        ...
                        for (; o < j;)o += h;
                        for (; o < k; o += h)a.push({value: o, move: "in"}), a.push({
                            value: o +
        ...
        d(h.prototype, "generatePoints", function (a) {
            ...
            var c = this.xAxis, d = this.yAxis,
                e = this.points, f, g = e.length, h = this.options.connectNulls, o;
            if (c && d && (c.options.breaks || d.options.breaks))for (; g--;)if (f = e[g], o = f.y === null && h === !1, !o && (c.isInAnyBreak(f.x, !0) || d.isInAnyBreak(f.y, !0)))e.splice(g, 1), this.data[g] && this.data[g].destroyElements()
        });
        d(a.seriesTypes.column.prototype, "drawPoints", function (a) {
            a.apply(this);
            var a = this.points, b = this.yAxis, d = b.breakArray || [], e = c(this.options.threshold, b.min), g, h, q, o, p, s;
            for (o = 0; o < a.length; o++) {
                ...
                for (p = 0; p < d.length; p++) {
                    q = d[p];
                    g = !1;
                    if (e < q.from && s > q.to || e > q.from && s < q.from)g = "pointBreak"; else if (e < q.from && s > q.from && s < q.to || e > q.from && s > q.to && s < q.from)g = "pointInBreak";
                    g && f(b, g, {point: h, brk: q})
                }
            }
        })
    })(D);
    var da = P.prototype, S = Kb.prototype, ic = da.processData, jc = da.generatePoints, kc = da.destroy, lc = S.tooltipFooterHeaderFormatter, mc = {
    ...
    }, Xb = [["millisecond", [1, 2, 5, 10, 20, 25, 50, 100, 200, 500]], ["second", [1, 2, 5, 10, 15, 30]], ["minute", [1, 2, 5, 10, 15, 30]], ["hour", [1, 2, 3, 4, 6, 8, 12]], ["day", [1]], ["week", [1]], ["month", [1, 3, 6]], ["year", null]], Pa = {
        sum: function (a) {
            var b = a.length, c;
    ...
    da.groupData = function (a, b, c, d) {
        var e =
            this.data, f = this.options.data, g = [], h = [], i = a.length, k, j, m = !!b, l = [[], [], [], []], d = typeof d === "function" ? d : Pa[d], n = this.pointArrayMap, q = n && n.length, o;
        for (o = 0; o <= i; o++)if (a[o] >= c[0])break;
        for (; o <= i; o++) {
            for (; c[1] !== s && a[o] >= c[1] || o === i;)if (k = c.shift(), j = d.apply(0, l), j !== s && (g.push(k), h.push(j)), l[0] = [], l[1] = [], l[2] = [], l[3] = [], o === i)break;
            if (o === i)break;
            if (n) {
                k = this.cropStart + o;
                k = e && e[k] || this.pointClass.prototype.applyOptions.apply({series: this}, [f[k]]);
                var p;
                for (j = 0; j < q; j++)if (p = k[n[j]], typeof p === "number")l[j].push(p);
    ...
    da.processData = function () {
        ...
        if (ic.apply(this, arguments) !== !1 && d) {
            ...
            var f = this.processedXData, g = this.processedYData, h = a.plotSizeX, a = this.xAxis, i = a.options.ordinal, k = this.groupPixelWidth =
                a.getGroupPixelWidth && a.getGroupPixelWidth(), d = this.pointRange;
            if (k) {
                e = !0;
                this.points = null;
                var j = a.getExtremes(), d = j.min, j = j.max, i = i && a.getGroupIntervalFactor(d, j, this) || 1, h = k * (j - d) / h * i, k = a.getTimeTicks(a.normalizeTimeTickInterval(h, c.units || Xb), d, j, a.options.startOfWeek, f, this.closestPointRange), g = da.groupData.apply(this, [f, g, k, c.approximation]), f = g[0], g = g[1];
                if (c.smoothed) {
                    c = f.length - 1;
    ...
    H.prototype.setDataGrouping = function (a, b) {
        ...
        if (this instanceof H)for (c = this.series.length; c--;)this.series[c].update({dataGrouping: a}, !1); else o(this.chart.options.series,
            function (b) {
                b.dataGrouping = a
            }, !1);
        b && this.chart.redraw()
    ...
    S = ia(K.column, {
        type: "ohlc", pointArrayMap: ["open", "high", "low", "close"], toYData: function (a) {
        ...
        }, upColorProp: "stroke", getAttribs: function () {
            K.column.prototype.getAttribs.apply(this, arguments);
            var a = this.options, b = a.states, a = a.upColor || this.color, c = B(this.pointAttr), d = this.upColorProp;
            c[""][d] = a;
            ...
            o(a.points, function (j) {
                if (j.plotY !== s)i = j.graphic, c = j.pointAttr[j.selected ? "selected" : ""] || a.pointAttr[""], f = c["stroke-width"] % 2 / 2, k = x(j.plotX) - f, g = x(j.shapeArgs.width / 2), h = ["M", k, x(j.yBottom), "L", k, x(j.plotY)], j.open !== null && (d = x(j.plotOpen) + f, h.push("M", k, d, "L", k - g, d)), j.close !== null && (e = x(j.plotClose) + f, h.push("M", k, e, "L", k + g, e)), i ? i.attr(c).animate({d: h}) :
    ...
    S = ia(S, {
        ...
        getAttribs: function () {
            ...
            var a = this.options, b = a.states, c = a.upLineColor || a.lineColor, d = b.hover.upLineColor || c, e =
        ...
        drawPoints: function () {
            var a = this, b = a.chart, c, d = a.pointAttr[""], e, f, g, h, i, k, j, m, l, n, q;
    ...
    K.flags = ia(K.column, {
        ...
        translate: function () {
            K.column.prototype.translate.apply(this);
            var a = this.chart, b = this.points, c = b.length - 1, d, e, f = this.options.onSeries, f = (d = f && a.get(f)) && d.options.step,
                g = d && d.points, h = g && g.length, i = this.xAxis, k = i.getExtremes(), j, m, l;
            if (d && d.visible && h) {
        ...
        drawPoints: function () {
            var a, b = this.pointAttr[""], c = this.points, d = this.chart.renderer, e, f, g = this.options, h = g.y, i, k, j, m, l, n;
            for (k = c.length; k--;)if (j = c[k], a = j.plotX > this.xAxis.len, e = j.plotX, e > 0 && (e -= p(j.lineWidth, g.lineWidth) % 2), m = j.stackIndex, i = j.options.shape || g.shape, f = j.plotY, f !== s && (f = j.plotY + h - (m !== s && m * g.stackDistance)), l = m ? s : j.plotX, n = m ? s : j.plotY, m = j.graphic, f !== s && e >= 0 && !a)a =
    ...
    Fb.prototype = {
        drawHandle: function (a, b) {
                ...
                if (!(m.translate(d, !0) - m.translate(c, !0) < e.xAxis[0].minRange)) {
                    ...
                    if (A) {
                        this.leftShade[e](s.maskInside ? {x: g + b, y: w, width: c - b, height: y} : {
                            x: g,
                            y: w, width: b, height: y
                        });
                        if (this.rightShade)this.rightShade[e]({x: g + c, y: w, width: h - c, height: y});
                        this.outline[e]({d: ["M", i, G, "L", g + b - D, G, g + b - D, G + I, "L", g + c - D, G + I, "L", g + c - D, G, i + k, G].concat(s.maskInside ? ["M", g + b + D, G, "L", g + c - D, G] : [])});
                    ...
                    if (r && j)this.drawScrollbarButton(0), this.drawScrollbarButton(1), j[e]({
                        translateX: i,
                        translateY: x(G + y)
                    }), n[e]({width: k}), g = o + b, h = a - H, h < u && (F = (u - h) / 2, h = u, g -= F), this.scrollbarPad = F, l[e]({
                        x: T(g) + H % 2 / 2,
                        width: h
            ...
            var a = this, b = a.chart, c, d, e = a.scrollbarHeight, f = a.navigatorOptions, g = a.height, h = a.top, i, k, j = a.baseSeries;
            a.mouseDownHandler = function (d) {
                var d = b.pointer.normalize(d), e = a.zoomedMin, f = a.zoomedMax, h = a.top, j = a.scrollbarHeight, k = a.scrollerLeft, l = a.scrollerWidth, m = a.navigatorLeft, o = a.navigatorWidth, p = a.scrollbarPad, s = a.range, t = d.chartX, v = d.chartY, d = b.xAxis[0], w, x = eb ? 10 : 7;
                if (v >
                    h && v < h + g + j)if ((h = !a.scrollbarEnabled || v < h + g) && Y.abs(t - e - m) < x)a.grabbedLeft = !0, a.otherHandlePos = f, a.fixedExtreme = d.max, b.fixedRange = null; else if (h && Y.abs(t - f - m) < x)a.grabbedRight = !0, a.otherHandlePos = e, a.fixedExtreme = d.min, b.fixedRange = null; else if (t > m + e - p && t < m + f + p)a.grabbedCenter = t, a.fixedWidth = s, i = t - e; else if (t > k && t < k + l) {
                    f = h ? t - m - s / 2 : t < m ? e - s * 0.2 : t > k + l - j ? e + s * 0.2 : t < m + e ? e - s : f;
                    if (f < 0)f = 0; else if (f + s >= o)f = o - s, w = a.getUnionExtremes().dataMax;
            ...
            a.navigatorEnabled ? (a.xAxis = c = new H(b, B({
                ...
                translate: function (a, c) {
                    var d = b.xAxis[0], f = d.getExtremes(), g = b.plotWidth - 2 * e, h = ub("min", d.options.min, f.dataMin), d = ub("max", d.options.max, f.dataMax) - h;
            ...
            if (a && this.navigatorOptions.adaptToUpdatedData !== !1)A(a, "updatedData", this.updatedDataHandler), a.userOptions.events = w(a.userOptions.event, {updatedData: this.updatedDataHandler})
        }, updatedDataHandler: function () {
            var a = this.chart.scroller, b = a.baseSeries, c = b.xAxis, d = c.getExtremes(), e = d.min, f = d.max, g = d.dataMin, d = d.dataMax, h = f - e, i, k, j, m, l, n = a.series;
            i = n.xData;
            var o = !!c.setExtremes;
            ...
            k && (j = d, i || (m = v(j -
            h, n.xData[0])));
            o && (i || k) ? isNaN(m) || c.setExtremes(m, j, !0, !1, {trigger: "updatedData"}) : (l && this.chart.redraw(!1), a.render(v(e, g), E(f, d)))
        }, destroy: function () {
            this.removeEvents();
    ...
    N.lang = B(N.lang, {rangeSelectorZoom: "Zoom", rangeSelectorFrom: "From", rangeSelectorTo: "To"});
    Gb.prototype = {
        clickButton: function (a, b) {
            var c = this, d = c.selected, e = c.chart, f = c.buttons, g = c.buttonOptions[a], h = e.xAxis[0], i = e.scroller && e.scroller.getUnionExtremes() || h || {}, k = i.dataMin, j = i.dataMax, m, l = h && x(E(h.max, p(j, h.max))), n = g.type, q, i = g._range,
                r, t, w, u = g.dataGrouping;
            if (!(k === null || j === null || a === c.selected)) {
                e.fixedRange = i;
                if (u)this.forcedDataGrouping = !0, H.prototype.setDataGrouping.call(h || {chart: this.chart}, u, !1);
                if (n === "month" || n === "year")if (h) {
                    if (n = {
                            range: g,
                            max: l,
                            dataMin: k,
                ...
                } else i = g; else if (i)m = v(l - i, k), l = E(m + i, j); else if (n === "ytd")if (h) {
            ...
            var b = this, c = this.chart, d = c.xAxis[0], e = c.scroller && c.scroller.getUnionExtremes() || d, f = e.dataMin, g = e.dataMax, h = b.selected, i = b.options.allButtonsEnabled,
                k = b.buttons;
            a && c.fixedRange !== x(d.max - d.min) && (k[h] && k[h].setState(0), b.setSelected(null));
            o(b.buttonOptions, function (a, e) {
                var l = x(d.max - d.min), n = a._range, o = a.type, p = a.count || 1, s = n > g - f, t = n < d.minRange, u = a.type === "all" && d.max - d.min >= g - f && k[e].state !== 2, v = a.type === "ytd" && ja("%Y", f) === ja("%Y", g), w = c.renderer.forExport && e === h, n = n === l;
                if ((o === "month" || o === "year") && l >= {month: 28, year: 365}[o] * 864E5 * p && l <= {
                        month: 31,
                        year: 366
                    }[o] * 864E5 * p)n = !0;
            ...
            this[a + "Label"] = k = e.label(N.lang[h ?
                "rangeSelectorFrom" : "rangeSelectorTo"], this.inputGroup.offset).attr({padding: 2}).css(B(d, f.labelStyle)).add(j);
            j.offset += k.width + 5;
            this[a + "DateBox"] = e = e.label("", j.offset).attr({
                ...
                "stroke-width": 1
            }).css(B({textAlign: "center", color: "#444"}, d, f.inputStyle)).on("click", function () {
                b.showInput(a);
                b[a + "Input"].focus()
            }).add(j);
            ...
            i.onchange = function () {
                var a = i.value, d = (f.inputDateParser || fa.parse)(a), e = c.xAxis[0], g = e.dataMin, j = e.dataMax;
            ...
            var a = this.chart, b = a.options.rangeSelector, a = p((b.buttonPosition || {}).y, a.plotTop - a.axisOffset[0] - b.height);
            return {buttonTop: a, inputTop: a - 10}
        }, render: function (a, b) {
            var c = this, d = c.chart, e = d.renderer, f = d.container, g = d.options, h = g.exporting && g.navigation && g.navigation.buttonOptions, i = g.rangeSelector, k = c.buttons, g = N.lang, j = c.div, j = c.inputGroup,
                m = i.buttonTheme, l = i.buttonPosition || {}, n = i.inputEnabled, q = m && m.states, r = d.plotLeft, s, v = this.getPosition(), u = c.group, y = c.rendered;
            if (!y && (c.group = u = e.g("range-selector-buttons").add(), c.zoomText = e.text(g.rangeSelectorZoom, p(l.x, r), 15).css(i.labelStyle).add(u), s = p(l.x, r) + c.zoomText.getBBox().width + 5, o(c.buttonOptions, function (a, b) {
                    k[b] = e.button(a.text, s, 0, function () {
                        c.clickButton(b);
                        c.isActive = !0
                    }, m, q && q.hover, q && q.select, q && q.disabled).css({textAlign: "center"}).add(u);
            ...
            u[y ? "animate" : "attr"]({translateY: v.buttonTop});
            n !== !1 && (j.align(w({
                y: v.inputTop,
                width: j.offset,
    ...
    H.prototype.toFixedRange = function (a, b, c, d) {
        var e = this.chart && this.chart.fixedRange, a = p(c,
            this.translate(a, !0)), b = p(d, this.translate(b, !0)), c = e && (b - a) / e;
    ...
    D.StockChart = function (a, b) {
        var c = a.series, d, e = p(a.navigator && a.navigator.enabled, !0) ? {
            startOnTick: !1,
            endOnTick: !1
        } : null, f = {marker: {enabled: !1, radius: 2}}, g = {shadow: !1, borderWidth: 0};
        a.xAxis = Aa(na(a.xAxis ||
        {}), function (a) {
            return B({
                minPadding: 0,
                maxPadding: 0,
        ...
        a.yAxis = Aa(na(a.yAxis || {}), function (a) {
            d = p(a.opposite, !0);
            return B({labels: {y: -2}, opposite: d, showLastLabel: !1, title: {text: null}}, a)
        });
        a.series = null;
        a = B({
    ...
    R(H.prototype, "autoLabelAlign", function (a) {
        var b = this.chart,
            c = this.options, b = b._labelPanes = b._labelPanes || {}, d = this.options.labels;
    ...
    R(H.prototype, "getPlotLinePath", function (a, b, c, d, e, f) {
        var g = this, h = this.isLinked && !this.series ? this.linkedParent.series : this.series, i = g.chart, k = i.renderer, j = g.left, m = g.top, l, n, q, r, s = [], w = [], u;
        ...
        o(g.isXAxis ? i.yAxis : i.xAxis, function (a) {
            if (t(a.options.id) ? a.options.id.indexOf("navigator") === -1 : 1) {
                var b = a.isXAxis ? "yAxis" : "xAxis", b = t(a.options[b]) ? i[b][a.options[b]] : i[b][0];
                g === b && w.push(a)
            }
        });
    ...
    H.prototype.getPlotBandPath = function (a, b) {
        ...
        if (d &&
            c && d.toString() !== c.toString())for (f = 0; f < d.length; f += 6)e.push("M", d[f + 1], d[f + 2], "L", d[f + 4], d[f + 5], c[f + 4], c[f + 5], c[f + 1], c[f + 2]); else e = null;
        return e
    };
    ...
    R(H.prototype, "drawCrosshair", function (a, b, c) {
        ...
        if (t(this.crosshair.label) && this.crosshair.label.enabled && t(c)) {
            var a = this.chart, f = this.options.crosshair.label, g = this.isXAxis ? "x" : "y", b = this.horiz, h = this.opposite, i = this.left, k = this.top, j = this.crossLabel, m, l, n = f.format, o = "";
            ...
            if (l < k || l > k + this.height)this.hideCrosshair(); else {
                !n && !f.formatter && (this.isDatetimeAxis && (o = "%b %d, %Y"), n = "{value" + (o ? ":" + o : "") + "}");
                j.attr({
                    text: n ?
                        La(n, {value: c[g]}) : f.formatter.call(this, c[g]), x: m, y: l, visibility: "visible"
                });
                c = j.getBBox();
                if (b) {
                ...
                j.attr({x: m, y: l, visibility: "visible"})
            }
        }
    });
    var nc = da.init, oc = da.processData,
