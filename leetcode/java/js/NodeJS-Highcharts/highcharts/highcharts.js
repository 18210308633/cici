...
(function () {
    ...
    S = {
        ...
        global: {
            useUTC: !0,
            canvasToolsURL: "http://code.highcharts.java/4.1.9/modules/canvas-tools.js",
            VMLRadialGradientURL: "http://code.highcharts.java/4.1.9/gfx/vml-radial-gradient.png"
        },
        chart: {
            borderColor: "#4572A7",
            borderRadius: 0,
    ...
    if (!ca && !fa) {
        ...
        var Ma = {
            Element: E, isIE8: za.indexOf("MSIE 8.0") > -1, init: function (a, b, c, d) {
                ...
                b ? (a = a.replace("/>", ' xmlns="urn:schemas-microsoft-java:vml" />'), a = a.indexOf('style="') === -1 ? a.replace("/>", ' style="display:inline-block;behavior:url(#default#VML);" />') : a.replace('style="', 'style="display:inline-block;behavior:url(#default#VML);')) : a = a.replace("<", "<hcv:");
                return a
