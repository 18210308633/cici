...
(function () {
    ...
    function N(a, b, c) {
        var d, e;
        if (Aa(b))x(c) ? a.setAttribute(b, c) : a && a.getAttribute && (e = a.getAttribute(b)); else if (x(b) && ha(b))for (d in b)a.setAttribute(d, b[d]);
        return e
    }
    ...
    function ub() {
        var a = J.global, b = a.useUTC, c = b ? "getUTC" : "get", d = b ? "setUTC" : "set";
    ...
    var r, C = document, H = window, G = Math, A = G.round, ga = G.floor, ta = G.ceil, t = G.max, E = G.min, O = G.abs, ja = G.cos, oa = G.sin, mb = G.PI, ka = mb * 2 / 360, ya = navigator.userAgent, Eb = H.opera, sa = /(msie|trident|edge)/i.test(ya) && !Eb, bb = C.documentMode === 8, cb = !sa && /AppleWebKit/.test(ya), Ha = /Firefox/.test(ya), Fb = /(Mobile|Android|Windows Phone)/.test(ya), Ba = "http://www.w3.org/2000/svg", fa = !!C.createElementNS && !!C.createElementNS(Ba, "svg").createSVGRect, Lb = Ha && parseInt(ya.split("Firefox/")[1], 10) < 4, ia = !fa && !sa && !!C.createElement("canvas").getContext,
        Na, Sa, Gb = {}, nb = 0, ab, J, Ka, ob, db, T = function () {
            return r
        }, X = [], Ta = 0, Fa = "div", S = "none", Mb = /^[0-9]+$/, eb = ["plotTop", "marginRight", "marginBottom", "plotLeft"], Nb = "stroke-width", Ga, vb, jb, wb, xb, yb, zb, kb, lb, Ab, Bb, v = {}, B;
    ...
    Ka = function (a, b, c) {
        ...
        var a = p(a, "%Y-%m-%d %H:%M:%S"), d = new Ga(b - (jb && jb(b) || vb || 0) * 6E4), e, f = d[xb](), g = d[yb](), h = d[zb](), i = d[kb](), j = d[lb](), k = J.lang, l = k.weekdays, d = q({
            a: l[g].substr(0, 3),
            A: l[g],
            d: Da(h),
            e: h,
    ...
    B.numberFormat = function (a, b, c, d) {
        var e = J.lang, a = +a || 0, f = b === -1 ? E((a.toString().split(".")[1] || "").length, 20) : isNaN(b = O(b)) ? 2 : b, b = c === void 0 ? e.decimalPoint : c, d = d === void 0 ? e.thousandsSep : d, e = a < 0 ? "-" : "", c = String(D(a = O(a).toFixed(f))),
    ...
    var M = H.HighchartsAdapter, U = M || {};
    M && M.init.call(M, ob);
    var fb = U.adapterRun, Ob = U.getScript, Ua = U.inArray, o = B.each = U.each, pb = U.grep, Pb = U.offset, Oa = U.map, L = U.addEvent, aa = U.removeEvent, I = U.fireEvent, Qb = U.washMouseEvent, gb = U.animate, Va = U.stop;
    J = {
        ...
        global: {
            useUTC: !0,
            canvasToolsURL: "http://code.highcharts.java/maps/1.1.9/modules/canvas-tools.js",
            VMLRadialGradientURL: "http://code.highcharts.java/maps/1.1.9/gfx/vml-radial-gradient.png"
        },
        chart: {
            borderColor: "#4572A7",
            borderRadius: 0,
    ...
    var V = J.plotOptions, U = V.line;
    ub();
    var Rb = /rgba\(\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*,\s*([0-9]?(?:\.[0-9]+)?)\s*\)/, Sb = /#([a-fA-F0-9]{2})([a-fA-F0-9]{2})([a-fA-F0-9]{2})/, Tb = /rgb\(\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*\)/, W = function (a) {
        var b = [], c, d;
        (function (a) {
    ...
    R.prototype = {
        ...
        colorGradient: function (a, b, c) {
            var d = this.renderer, e, f, g, h, i, j, k, l, n, m, u, s = [];
            ...
            if (f) {
                ...
                f === "radialGradient" && m && !x(g.gradientUnits) && (h = g, g = w(g, d.getRadialAttr(m, h), {gradientUnits: "userSpaceOnUse"}));
                ...
                i[s] ? a = i[s].attr("id") :
                    (g.id = a = "highcharts-" + nb++, i[s] = j = d.createElement(f).attr(g).add(d.defs), j.radAttr = h, j.stops = [], o(k, function (a) {
                        ...
                        a = d.createElement("stop").attr({offset: a[0], "stop-color": l, "stop-opacity": n}).add(j);
                        j.stops.push(a)
                    }));
        ...
        applyTextShadow: function (a) {
            var b = this.element, c, d = a.indexOf("contrast") !== -1, e = {}, f = this.renderer.forExport, g = f || b.style.textShadow !== r && !sa;
            if (d)e.textShadow =
        ...
        addClass: function (a) {
            var b = this.element, c = N(b, "class") || "";
        ...
        css: function (a) {
            ...
            if (e) {
                ...
                if (sa && !fa)K(this.element, a); else {
                    b = function (a, b) {
        ...
        getBBox: function (a) {
            var b, c = this.renderer, d, e = this.rotation, f = this.element, g = this.styles, h = e * ka;
            d = this.textStr;
            var i, j = f.style, k, l;
        ...
        zIndexSetter: function (a, b) {
            ...
            if (e) {
                ...
                d = c.childNodes;
                for (i = 0; i <
                d.length && !h; i++)if (e = d[i], f = N(e, "zIndex"), e !== g && (D(f) > a || !x(a) && x(f)))c.insertBefore(g, e), h = !0;
                h || c.appendChild(g)
            }
            return h
        },
    ...
    R.prototype["stroke-widthSetter"] = R.prototype.strokeSetter = function (a,
                                                                             b, c) {
        this[b] = a;
        if (this.stroke && this["stroke-width"])this.strokeWidth = this["stroke-width"], R.prototype.fillSetter.call(this, this.stroke, "stroke", c), c.setAttribute("stroke-width", this["stroke-width"]), this.hasStroke = !0; else if (b === "stroke-width" && a === 0 && this.hasStroke)c.removeAttribute("stroke"), this.hasStroke = !1
    };
    var la = function () {
        this.init.apply(this, arguments)
    };
    la.prototype = {
        Element: R, init: function (a, b, c, d, e, f) {
            ...
            if (Ha && a.getBoundingClientRect)this.subPixelFix = b = function () {
                ...
                K(a, {left: ta(i.left) - i.left + "px", top: ta(i.top) - i.top + "px"})
            }, b(), L(H, "resize", b)
        }, getStyle: function (a) {
            return this.style = q({
            ...
            !f && !m && !u && e.indexOf(" ") === -1 ? b.appendChild(C.createTextNode(z(e))) : (h = /<.*style="([^"]+)".*>/, i = /<.*href="(http[^"]+)".*>/, P && P.appendChild(b), e = f ? e.replace(/<(b|strong)>/g, '<span style="font-weight:bold">').replace(/<(i|em)>/g,
                ...
                o(g, function (e) {
                    if (e !== "" || g.length === 1) {
                        var m = {}, s = C.createElementNS(Ba, "tspan"), o;
                        ...
                        if (e !== " ") {
                            ...
                            N(s, m);
                            b.appendChild(s);
                            !n && f && (!fa && d && K(s, {display: "block"}), N(s, "dy", y(s)));
                            if (l) {
                                for (var m = e.replace(/([^\^])-/g, "$1- ").split(" "), p = g.length > 1 || f || m.length > 1 && k.whiteSpace !== "nowrap", P, ba, r, x = [], q = y(s), t = 1, A = a.rotation, w = e, v = w.length; (p || u) && (m.length || x.length);)a.rotation = 0, P = a.getBBox(!0), r = P.width, !fa && c.forExport && (r = c.measureSpanWidth(s.firstChild.data,
            ...
            var j = this.label(a, b, c, i, null, null, null, null, "button"), k = 0, l, n, m, u, s, o, a = {
                x1: 0,
                y1: 0,
                x2: 0,
                y2: 1
            ...
            var e = ha(a) ? a.r : e, g = this.createElement("rect"), a = ha(a) ? a : a === r ? {} : {
                x: a,
                y: b,
                width: t(c, 0),
                height: t(d, 0)
            ...
            return x(a) ? b.attr({"class": "highcharts-" + a}) : b
            ...
            var g, h = this.symbols[a], h = h && h(A(b),
                    A(c), d, e, f), i = /^url\((.*?)\)$/, j, k;
            if (h)g = this.path(h), q(g, {
                ...
                x: b,
                y: c
            }), g.isImg = !0, a ? k(g, a) : (g.attr({width: 0, height: 0}), ca("img", {
                onload: function () {
                    this.width === 0 && (K(this, {
                        position: "absolute",
                        top: "-999em"
            ...
            circle: function (a, b, c, d) {
                ...
                var f = e.start, c = e.r || c || d, g = e.end - 0.001, d = e.innerR, h = e.open, i = ja(f), j = oa(f), k = ja(g), g = oa(g), e = e.end - f < mb ? 0 : 1;
            ...
            function j() {
                ...
                if (E) {
                    ...
                    s.isImg || s.attr(q({width: A(m.width), height: A(m.height)}, F));
                    F = null
                }
            }

            function k() {
                var a = m.styles, a = a && a.textAlign, b = ba + z * (1 - y), c;
                c = h ? 0 : C;
                if (x(t) && p && (a === "center" || a === "right"))b += {center: 0.5, right: 1}[a] * (t - p.width);
            ...
            var n = this, m =
                n.g(i), u = n.text("", 0, 0, g).attr({zIndex: 1}), s, p, y = 0, z = 3, ba = 0, t, ua, qb, v, B = 0, F = {}, C, E;
            m.onAdd = function () {
                u.add(m);
                m.attr({text: a || a === 0 ? a : "", x: b, y: c});
                s && x(e) && m.attr({anchorX: e, anchorY: f})
            };
    ...
    q(R.prototype, {
        htmlCss: function (a) {
            ...
            if (this.added) {
                ...
                if (b.tagName === "SPAN") {
                    var k = this.rotation, l, n = D(this.textWidth), m = [k, g, b.innerHTML, this.textWidth, this.textAlign].join(",");
                    if (m !== this.cTT) {
            ...
            var d = {}, e = sa ? "-ms-transform" : cb ? "-webkit-transform" : Ha ? "MozTransform" : Eb ? "-o-transform" : "";
    ...
    if (!fa && !ia)M = {
        init: function (a, b) {
            var c = ["<", b, ' filled="f" stroked="f"'], d = ["position: ", "absolute", ";"], e = b === Fa;
            ...
            var a = this.rotation, b = ja(a * ka), c = oa(a * ka);
            K(this.element, {filter: a ? ["progid:DXImageTransform.Microsoft.Matrix(M11=", b, ", M12=", -c, ", M21=", c, ", M22=", b, ", sizingMethod='auto expand')"].join("") : S})
        }, getSpanCorrection: function (a, b, c, d,
                                        e) {
            var f = d ? ja(d * ka) : 1, g = d ? oa(d * ka) : 0, h = p(this.elemHeight, this.element.offsetHeight), i;
            this.xCorr = f < 0 && -a;
            this.yCorr = g < 0 && -h;
            i = f * g < 0;
            this.xCorr += g * b * (i ? 1 - c : c);
            this.yCorr -= f * b * (d ? i ? c : 1 - c : 1);
            e && e !== "left" && (this.xCorr -= a * c * (f < 0 ? -1 : 1), d && (this.yCorr -= h * c * (g < 0 ? -1 : 1)), K(this.element, {textAlign: e}))
        }, pathToVML: function (a) {
            for (var b = a.length, c = []; b--;)if (qa(a[b]))c[b] = A(a[b] * 10) - 5; else if (a[b] === "Z")c[b] = "x"; else if (c[b] = a[b], a.isArc && (a[b] === "wa" || a[b] === "at"))c[b + 5] === c[b + 7] && (c[b + 7] += a[b + 7] > a[b + 5] ? 1 : -1),
            ...
            var d = [], e, f = this.element, g = this.renderer, h, i = f.style, j, k = f.path, l, n, m, u;
            ...
            if (a) {
                ...
                for (e = 1; e <= 3; e++) {
                    ...
                    j = ['<shape isShadow="true" strokeweight="', l, '" filled="false" path="', n, '" coordsize="10 10" style="',
                        f.style.cssText, '" />'];
                    h = ca(g.prepVML(j), null, {left: D(i.left) + p(a.offsetX, 1), top: D(i.top) + p(a.offsetY, 1)});
                    if (c)h.cutOff = l + 1;
            ...
            return this
        }, updateShadows: T, setAttr: function (a, b) {
        ...
        }, opacitySetter: T, rotationSetter: function (a, b, c) {
            c = c.style;
            this[b] = c[b] = a;
        ...
        Element: M, isIE8: ya.indexOf("MSIE 8.0") > -1, init: function (a, b, c, d) {
            var e;
            this.alignedObjects = [];
            d = this.createElement(Fa).css(q(this.getStyle(d), {position: "relative"}));
            e = d.element;
            ...
            this.setSize(b, c, !1);
            if (!C.namespaces.hcv) {
                C.namespaces.add("hcv", "urn:schemas-microsoft-java:vml");
                try {
            ...
            return q(e, {
                ...
                getCSS: function (a) {
                    var b = a.element, c = b.nodeName, a = a.inverted, d = this.top - (c === "shape" ? b.offsetTop : 0), e = this.left, b = e + this.width, f = d + this.height, d = {clip: "rect(" + A(a ? e : d) + "px," + A(a ? f : b) + "px," + A(a ? b : f) + "px," + A(a ? d : e) + "px)"};
                    !a && bb && c === "DIV" && q(d, {width: b + "px", height: f + "px"});
                    return d
                },
        ...
        color: function (a, b, c, d) {
            ...
            if (i) {
                var k, l, n = a.linearGradient || a.radialGradient, m, u, s, p, y, z = "", a = a.stops, ba, r = [], ua = function () {
                ...
                if (c === "fill")if (i === "gradient")c = n.x1 || n[0] || 0, a = n.y1 || n[1] || 0, m = n.x2 || n[2] || 0, n = n.y2 || n[3] || 0, z = 'angle="' + (90 - G.atan((n - a) / (m - c)) * 180 / mb) + '"', ua(); else {
                    var j = n.r, t = j * 2, x = j * 2, q = n.cx, A = n.cy, w = b.radialReference, v, j = function () {
            ...
            } else if (g.test(a) && b.tagName !== "IMG")f = W(a), h = ["<", c, ' opacity="', f.get("a"), '"/>'], ca(this.prepVML(h), null, null, b), j = f.get("rgb"); else {
            ...
            b ? (a = a.replace("/>", ' xmlns="urn:schemas-microsoft-java:vml" />'), a = a.indexOf('style="') === -1 ? a.replace("/>", ' style="display:inline-block;behavior:url(#default#VML);" />') :
            ...
            arc: function (a, b, c, d, e) {
                var f = e.start, g = e.end, h = e.r || c ||
                    d, c = e.innerR, d = ja(f), i = oa(f), j = ja(g), k = oa(g);
                if (g - f === 0)return ["x"];
    ...
    Ma.prototype = {
        addLabel: function () {
            ...
            x(d) ? d && d.attr({text: b}) : (this.labelLength = (this.label = d = x(b) && g.enabled ? c.renderer.text(b, 0, 0, g.useHTML).css(w(g.style)).add(a.labelGroup) :
                null) && d.getBBox().width, this.rotation = 0)
        }, getLabelSize: function () {
            return this.label ? this.label.getBBox()[this.axis.horiz ? "height" : "width"] : 0
        }, handleOverflow: function (a) {
            var b = this.axis, c = a.x, d = b.chart.chartWidth, e = b.chart.spacing, f = p(b.labelLeft, E(b.pos, e[3])), e = p(b.labelRight, t(b.pos + b.len, d - e[1])), g = this.label, h = this.rotation, i = {
                left: 0,
                center: 0.5,
                right: 1
            }[b.labelAlign], j = g.getBBox().width, k = b.slotWidth, l = 1, n, m = {};
            if (h)h < 0 && c - i * j < f ? n = A(c / ja(h * ka) - f) : h > 0 && c + i * j > e && (n = A((d - c) / ja(h * ka))); else if (d =
            ...
            return f.crispLine(["M", a, b, "L", a + (e ? 0 : -c), b + (e ? c : 0)], d)
                             ...
                             b, c) {
            var d = this.axis, e = d.options, f = d.chart.renderer, g = d.horiz, h = this.type, i = this.label, j = this.pos, k = e.labels, l = this.gridLine, n = h ? h + "Grid" : "grid", m = h ? h + "Tick" : "tick", u = e[n + "LineWidth"], s = e[n + "LineColor"], o = e[n + "LineDashStyle"], y = e[m + "Length"], n = p(e[m + "Width"], !h && d.isXAxis ? 1 : 0), z = e[m + "Color"], ba = e[m + "Position"], m = this.mark, t = k.step, ua = !0, x = d.tickmarkOffset, q = this.getPosition(g, j, x, b), w = q.x, q = q.y, v = g && w === d.pos + d.len || !g && q === d.pos ? -1 : 1, c = p(c, 1);
            this.isActive = !0;
            if (u) {
                j = d.getPlotLinePath(j + x, u * v, b,
                    !0);
                if (l === r) {
                    l = {stroke: s, "stroke-width": u};
                    if (o)l.dashstyle = o;
                    if (!h)l.zIndex = 1;
                    if (b)l.opacity = 0;
            ...
            if (n && y)ba === "inside" && (y = -y), d.opposite && (y = -y), h = this.getMarkPath(w, q, y, n * v, g, f), m ? m.animate({
                d: h,
                opacity: c
            }) : this.mark = f.path(h).attr({stroke: z, "stroke-width": n, opacity: c}).add(d.axisGroup);
    ...
    Y.prototype = {
        ...
        setOptions: function (a) {
            ...
            {} : this.defaultYAxisOptions, [this.defaultTopAxisOptions, this.defaultRightAxisOptions, this.defaultBottomAxisOptions, this.defaultLeftAxisOptions][this.side], w(J[this.coll], a))
        },
        defaultLabelFormatter: function () {
            ...
            if (h)g = Ja(h, this); else if (c)g = b; else if (d)g = Ka(d, b); else if (f && a >= 1E3)for (; f-- && g === r;)c = Math.pow(1E3, f + 1), a >= c && b * 10 % c === 0 && e[f] !==
        ...
        getLinearTickPositions: function (a, b, c) {
            var d, e = xa(ga(b / a) * a), f = xa(ta(c / a) * a), g = [];
        ...
        adjustForMinRange: function () {
            var a =
                this.options, b = this.min, c = this.max, d, e = this.dataMax - this.dataMin >= this.minRange, f, g, h, i, j, k;
        ...
        setAxisTranslation: function (a) {
            ...
            if (k || i || d)if (h ? (f = h.minPointOffset, g = h.pointRangePadding) : o(b.series, function (a) {
        ...
        setTickInterval: function (a) {
            var b = this, c = b.chart, d = b.options, e = b.isLog, f = b.isDatetimeAxis, g = b.isXAxis, h = b.isLinked, i = d.maxPadding, j = d.minPadding, k = d.tickInterval, l = d.tickPixelInterval, n = b.categories, m = b.threshold, u = b.softThreshold,
                s, P, y, z;
            ...
            if (u && x(b.dataMin))if (m = m || 0, !x(y) && b.min < m && b.dataMin >= m)b.min = m; else if (!x(z) && b.max > m && b.dataMax <= m)b.max = m;
        ...
        zoom: function (a, b) {
            var c = this.dataMin, d = this.dataMax, e = this.options, f = E(c, p(e.min, c)), e = t(d, p(e.max, d));
        ...
        getThreshold: function (a) {
            var b = this.isLog, c = b ? na(this.min) : this.min, b = b ? na(this.max) : this.max;
        ...
        unsquish: function () {
            var a = this.ticks, b = this.options.labels, c = this.horiz, d = this.tickInterval, e = d, f = this.len / (((this.categories ? 1 : 0) + this.max - this.min) / d), g, h = b.rotation, i = this.chart.renderer.fontMetrics(b.style.fontSize,
                a[0] && a[0].label), j, k = Number.MAX_VALUE, l, n = function (a) {
                a /= f || 1;
                a = a > 1 ? ta(a) : 1;
                return a * d
            };
        ...
        renderUnsquish: function () {
            var a = this.chart, b = a.renderer, c = this.tickPositions, d = this.ticks, e = this.options.labels, f = this.horiz, g = a.margin, h = this.categories ?
                c.length : c.length - 1, i = this.slotWidth = f && !e.step && !e.rotation && (this.staggerLines || 1) * a.plotWidth / h || !f && (g[3] && g[3] - a.spacing[3] || a.chartWidth * 0.33), j = t(1, A(i - 2 * (e.padding || 5))), k = {}, g = b.fontMetrics(e.style.fontSize, d[0] && d[0].label), h = e.style.textOverflow, l, n = 0;
            if (!Aa(e.rotation))k.rotation = e.rotation || 0;
            if (this.autoRotation)o(c, function (a) {
                if ((a = d[a]) && a.labelLength > n)n = a.labelLength
            }), n > j && n > g.h ? k.rotation = this.labelRotation : this.labelRotation = 0; else if (i && (l = {width: j + "px"}, !h)) {
                l.textOverflow =
                    "clip";
            ...
            if (k.rotation && (l = {width: (n > a.chartHeight * 0.5 ? a.chartHeight * 0.33 : a.chartHeight) + "px"}, !h))l.textOverflow = "ellipsis";
        ...
        getOffset: function () {
            var a = this, b = a.chart, c = b.renderer, d = a.options, e = a.tickPositions, f = a.ticks, g = a.horiz, h = a.side, i = b.inverted ? [1, 0, 3, 2][h] : h, j, k, l = 0, n, m = 0, u = d.title, s = d.labels, P = 0, y = b.axisOffset, b = b.clipOffset, z = [-1, 1, 1, -1][h], q, r = a.axisParent;
            j = a.hasData();
            a.showAxis = k = j || p(d.showEmpty, !0);
            a.staggerLines = a.horiz && s.staggerLines;
            if (!a.axisGroup)a.gridGroup = c.g("grid").attr({zIndex: d.gridZIndex || 1}).add(r), a.axisGroup = c.g("axis").attr({zIndex: d.zIndex || 2}).add(r), a.labelGroup = c.g("axis-labels").attr({zIndex: s.zIndex || 7}).addClass("highcharts-" + a.coll.toLowerCase() + "-labels").add(r);
            if (j || a.isLinked) {
                if (o(e, function (b) {
        ...
        render: function () {
            var a = this, b = a.chart, c = b.renderer, d = a.options, e = a.isLog, f = a.isLinked, g = a.tickPositions,
                h = a.axisTitle, i = a.ticks, j = a.minorTicks, k = a.alternateBands, l = d.stackLabels, n = d.alternateGridColor, m = a.tickmarkOffset, u = d.lineWidth, s, p = b.hasRendered && x(a.oldMin) && !isNaN(a.oldMin), y = a.showAxis, z = c.globalAnimation, q, t;
            ...
            if (u)s = a.getLinePath(u), a.axisLine ? a.axisLine.animate({d: s}) : a.axisLine = c.path(s).attr({
                stroke: d.lineColor,
                "stroke-width": u,
                zIndex: 7
        ...
        drawCrosshair: function (a, b) {
            ...
            if (!this.crosshair || (x(b) || !p(this.crosshair.snap, !0)) === !1 || b && b.series && b.series[this.coll] !== this)this.hideCrosshair(); else if (p(d.snap, !0) ? x(b) && (c = this.isXAxis ? b.plotX : this.len - b.plotY) : c = this.horiz ? a.chartX - this.pos : this.len - a.chartY + this.pos, c = this.isRadial ? this.getPlotLinePath(this.isXAxis ? b.x : p(b.stackY, b.y)) || null : this.getPlotLinePath(null, null, null,
    ...
    Y.prototype.getLogTickPositions = function (a,
        ...
        if (a >= 0.5)a = A(a), g = this.getLinearTickPositions(a, b, c); else if (a >= 0.08)for (var f = ga(b), h, i, j, k, l, e = a > 0.3 ? [1, 2, 4] : a > 0.15 ? [1, 2, 4, 6, 8] : [1, 2, 3, 4, 5, 6, 7, 8, 9]; f < c + 1 && !l; f++) {
            i = e.length;
    ...
    Ib.prototype = {
        init: function (a, b) {
            ...
            var d = this.chart, e = this.distance, f = {}, g = c.h || 0, h, i = ["y", d.chartHeight, b, c.plotY + d.plotTop, d.plotTop, d.plotTop + d.plotHeight], j = ["x", d.chartWidth, a, c.plotX + d.plotLeft, d.plotLeft,
                d.plotLeft + d.plotWidth], k = p(c.ttBelow, d.inverted && !c.negative || !d.inverted && c.negative), l = function (a, b, c, d, h, i) {
                var j = c < d - e, n = d + e + c < b, l = d - e - c;
                d += e;
                if (k && n)f[a] = d; else if (!k && j)f[a] = l; else if (j)f[a] = E(i - c, l - g < 0 ? l : l - g); else if (n)f[a] = t(h, d + g + c > b ? d : d + g); else return !1
            }, n = function (a, b, c, d) {
            ...
            var i = c.hoverPoints, l, n = this.shared;
            clearTimeout(this.hideTimer);
            ...
            j === !1 ? this.hide() : (this.isHidden && (Va(d), d.attr("opacity", 1).show()), d.attr({text: j}), l = e.borderColor || a.color || i.color || "#606060", d.attr({stroke: l}), this.updatePosition({
                plotX: f, plotY: g,
                negative: a.negative, ttBelow: a.ttBelow, h: h[2] || 0
            }), this.isHidden = !1);
    ...
    za.prototype = {
        init: function (a, b) {
            ...
            return q(a, {chartX: A(c), chartY: A(d)})
            ...
            var b = this.chart, c = b.series, d = b.tooltip, e = d ? d.shared : !1, f = b.hoverPoint, g = b.hoverSeries, h, i = Number.MAX_VALUE, j, k, l = [], n, m;
            ...
            var b = this.chart, c = b.options.chart, d = a.chartX, e = a.chartY, f = this.zoomHor, g = this.zoomVert, h = b.plotLeft, i = b.plotTop, j = b.plotWidth, k = b.plotHeight, l, n = this.selectionMarker, m = this.mouseDownX, u = this.mouseDownY, s = c.panKey && a[c.panKey + "Key"];
            if (!n || !n.touch)if (d < h ? d = h : d > h + j && (d = h + j), e < i ? e = i : e > i + k && (e = i + k), this.hasDragged = Math.sqrt(Math.pow(m - d, 2) + Math.pow(u - e, 2)), this.hasDragged > 10) {
                ...
                n && f && (d -= m, n.attr({width: O(d), x: (d > 0 ? 0 : d) + m}));
            ...
            if (this.selectionMarker) {
                ...
                }, f = this.selectionMarker, g = f.attr ? f.attr("x") : f.x, h = f.attr ? f.attr("y") : f.y, i = f.attr ? f.attr("width") : f.width, j = f.attr ?
                    f.attr("height") : f.height, k;
                if (this.hasDragged || d)o(c.axes, function (c) {
                    if (c.zoomEnabled && x(c.min) && (d || b[{xAxis: "zoomX", yAxis: "zoomY"}[c.coll]])) {
                        var f = c.horiz, m = a.type === "touchend" ? c.minPixelPadding : 0, u = c.toValue((f ? g : h) + m), f = c.toValue((f ? g + i : h + j) - m);
                        e[c.coll].push({axis: c, min: E(u, f), max: t(u, f)});
                        k = !0
                    }
                }), k && I(c, "selection", e, function (a) {
                    c.zoom(q(a, d ? {animation: !1} : null))
                });
                this.selectionMarker = this.selectionMarker.destroy();
                d && this.scaleGroups()
            }
            if (c)K(c.container, {cursor: c._cursor}), c.cancelClick =
            ...
            for (var c; a;) {
                if (c = N(a, "class"))if (c.indexOf(b) !== -1)return !0; else if (c.indexOf("highcharts-container") !== -1)return !1;
                a = a.parentNode
            }
            ...
            a.originalEvent = a;
            b.cancelClick || (c && this.inClass(a.target, "highcharts-tracker") ? (I(c.series, "click", q(a, {point: c})), b.hoverPoint && c.firePointEvent("click", a)) : (q(a, this.getCoordinates(a)), b.isInsidePlot(a.chartX -
    ...
    q(B.Pointer.prototype, {
        pinchTranslate: function (a, b, c, d, e, f) {
            ...
            var i = this.chart, j = a ?
                "x" : "y", k = a ? "X" : "Y", l = "chart" + k, n = a ? "width" : "height", m = i["plot" + (a ? "Left" : "Top")], u, s, p = h || 1, o = i.inverted, z = i.bounds[a ? "h" : "v"], q = b.length === 1, t = b[0][l], r = c[0][l], x = !q && b[1][l], w = !q && c[1][l], v, c = function () {
            ...
            if (a.type === "touchstart")o(e, function (a, b) {
                ...
                function (a) {
                    if (a.zoomEnabled) {
                        var b = c.bounds[a.horiz ? "h" : "v"], d = a.minPixelPadding, e = a.toPixels(p(a.options.min, a.dataMin)), f = a.toPixels(p(a.options.max, a.dataMax)), g = E(e, f), e = t(e, f);
                        b.min = E(a.pos, g - d);
                        b.max = t(a.pos + a.len, e + d)
                    }
                }), b.res = !0; else if (d.length) {
                if (!i)b.selectionMarker = i = q({destroy: T, touch: !0}, c.plotBox);
    ...
    if (H.PointerEvent || H.MSPointerEvent) {
        var va = {}, rb = !!H.PointerEvent, Ub = function () {
            var a, b = [];
            b.item = function (a) {
                return this[a]
            };
        ...
        ea(za.prototype, "init", function (a, b, c) {
            a.call(this, b, c);
            this.hasZoom && K(b.container, {"-ms-touch-action": S, "touch-action": S})
        });
    ...
    Xa.prototype = {
        ...
        destroy: function () {
            ...
            var b = this.chart, c = b.renderer, d = this.options, e = d.layout === "horizontal", f = this.symbolWidth, g = d.symbolPadding, h = this.itemStyle, i = this.itemHiddenStyle,
                j = this.padding, k = e ? p(d.itemDistance, 20) : 0, l = !d.rtl, n = d.width, m = d.itemMarginBottom || 0, u = this.itemMarginTop, s = this.initialItemX, o = a.legendItem, y = a.series && a.series.drawLegendSymbol ? a.series : a, z = y.options, z = this.createCheckboxForItem && z && z.showCheckbox, q = d.useHTML;
            if (!o) {
            ...
            var b = this, c =
                this.chart, d = c.renderer, e = this.options, f = e.y, f = c.spacingBox.height + (e.verticalAlign === "top" ? -f : f) - this.padding, g = e.maxHeight, h, i = this.clipRect, j = e.navigation, k = p(j.animation, !0), l = j.arrowSize || 12, n = this.nav, m = this.pages, u = this.padding, s, q = this.allItems, y = function (a) {
                i.attr({height: a});
            ...
            if (a > f) {
                ...
                this.fullHeight = a;
                o(q, function (a, b) {
                    var c = a._legendItemPos[1], d = A(a.legendItem.getBBox().height), e = m.length;
                ...
                b.scroll(0);
                a = f
            } else if (n)y(c.chartHeight), n.hide(), this.scrollGroup.attr({translateY: 1}), this.clipHeight = 0;
            return a
        }, scroll: function (a, b) {
    ...
    var Ya = B.LegendSymbolMixin = {
        drawRectangle: function (a, b) {
            ...
            d = a.symbolWidth;
            var e = this.chart.renderer, f = this.legendGroup, a = a.baseline - A(a.fontMetrics.b * 0.3), g;
            if (b.lineWidth) {
    ...
    ma.prototype = {
        ...
        redraw: function (a) {
            var b = this.axes, c = this.series, d = this.pointer, e = this.legend, f = this.isDirtyLegend, g, h, i = this.hasCartesianSeries, j = this.isDirtyBox, k = c.length, l = k, n = this.renderer, m = n.isHidden(), p = [];
            Ra(a, this);
            ...
            d && (d.css({width: (e.width || h) + "px"}).align(q({y: b + (f.margin - 13) + g.fontMetrics(e.style.fontSize, c).b}, e), !1, "spacingBox"),
            ...
            var b = this, c = b.options.chart, d = b.renderTo, e = c.width || fb(d, "width"), f = c.height || fb(d, "height"), c = a ? a.target : H, d = function () {
            ...
            a = h.globalAnimation;
            (a ? gb : K)(d.container, {width: e + "px", height: f + "px"}, a);
            d.setChartSize(!0);
            h.setSize(e, f, c);
            d.maxTicks = null;
            o(d.axes, function (a) {
            ...
            if (k)f ? f.animate(z) : this.plotBackground = b.rect(p, o, q, y, 0).attr({fill: k}).add().shadow(a.plotShadow);
            ...
            b.items && o(b.items, function (c) {
                var d = q(b.style, c.style), e = D(d.left) + a.plotLeft, f = D(d.top) + a.plotTop + 12;
                delete d.left;
                delete d.top;
    ...
    Z.prototype = {
        init: function (a, b, c) {
            ...
            var c = this.series, d = c.options.pointValKey || c.pointValKey, a = Z.prototype.optionsToObject.call(this, a);
            q(this, a);
            ...
            if (typeof a === "number" || a === null)b[e[0]] = a; else if (Ca(a)) {
                if (!d && a.length > f) {
                    c = typeof a[0];
    ...
    Q.prototype =
    {
        ...
        setData: function (a, b, c, d) {
            var e = this, f = e.points, g = f && f.length || 0, h, i = e.options, j = e.chart, k = null, l = e.xAxis, n = l && !!l.categories, m = i.turboThreshold, u = this.xData, s = this.yData, q = (h = e.pointArrayMap) && h.length, a = a || [];
            h = a.length;
            b = p(b, !0);
            if (d !== !1 && h && g === h && !e.cropped && !e.hasGroupedData && e.visible)o(a, function (a, b) {
                ...
                if (m && h > m) {
                    ...
                    if (qa(k)) {
                        ...
                        e.xIncrement = n
                    } else if (Ca(k))if (q)for (c = 0; c < h; c++)k = a[c], u[c] = k[0], s[c] = k.slice(1, q + 1); else for (c = 0; c < h; c++)k = a[c], u[c] = k[0], s[c] = k[1]; else da(12)
                } else for (c = 0; c < h; c++)if (a[c] !== r && (k = {series: e}, e.pointClass.prototype.applyOptions.apply(k,
                        [a[c]]), e.updateParallelArrays(k, c), n && x(k.name)))l.names[k.x] = k.name;
                Aa(s[0]) && da(14, !0);
                e.data = [];
                e.options.data = a;
        ...
        processData: function (a) {
            ...
            var k = this.getExtremesFromAll || j.getExtremesFromAll,
                l = this.isCartesian, n, m;
            if (l && !this.isDirty && !h.isDirty && !this.yAxis.isDirty && !a)return !1;
            if (h)a = h.getExtremes(), n = a.min, m = a.max;
            if (l && this.sorted && !k && (!i || d > i || this.forceCrop))if (b[d - 1] < n || b[0] > m)b = [], c = []; else if (b[0] < n || b[d - 1] > m)e = this.cropData(this.xData, this.yData, n, m), b = e.xData, c = e.yData, e = e.start, f = !0;
        ...
        getExtremes: function (a) {
            ...
            d = a.length;
            for (l = 0; l < d; l++)if (j = c[l], k = a[l], i = k !== null && k !==
                r && (!b.isLog || k.length || k > 0), j = this.getExtremesFromAll || this.options.getExtremesFromAll || this.cropped || (c[l + 1] || j) >= g && (c[l - 1] || j) <= h, i && j)if (i = k.length)for (; i--;)k[i] !== null && (e[f++] = k[i]); else e[f++] = k;
            this.dataMin = Qa(e);
            this.dataMax = Ea(e)
        },
        translate: function () {
        ...
        setClip: function (a) {
            var b = this.chart, c = this.options, d = b.renderer, e = b.inverted,
                f = this.clipBox, g = f || b.clipBox, h = this.sharedClipKey || ["_sharedClip", a && a.duration, a && a.easing, g.height, c.xAxis, c.yAxis].join(","), i = b[h], j = b[h + "m"];
            if (!i) {
        ...
        drawPoints: function () {
            var a, b = this.points, c = this.chart, d, e, f, g, h, i, j, k, l = this.options.marker, n = this.pointAttr[""], m, o, s, t = this.markerGroup, y = p(l.enabled, this.xAxis.isRadial, this.closestPointRangePx > 2 * l.radius);
            if (l.enabled !== !1 || this._hasPointMarkers)for (f = b.length; f--;)if (g = b[f], d = ga(g.plotX), e = g.plotY, k = g.graphic, m = g.marker || {}, o = !!g.marker, a = y && m.enabled === r || m.enabled, s = g.isInside, a && e !== r && !isNaN(e) && g.y !== null)if (a = g.pointAttr[g.selected ? "select" : ""] || n, h = a.r, i = p(m.symbol, this.symbol), j = i.indexOf("url") === 0, k)k[s ? "show" : "hide"](!0).animate(q({
                x: d - h,
                y: e - h
        ...
        getAttribs: function () {
            ...
            var m = c.lineColor, u = c.fillColor;
            k = b.turboThreshold;
            var s = a.zones, t = a.zoneAxis || "y", y;
            b.marker ? (e.radius =
            ...
            if (!k || g < k || j)for (; g--;) {
                ...
                if (k.options)for (y in n)x(c[n[y]]) && (j = !0);
                if (j) {
                    c = c || {};
                    j = [];
                    d = c.states || {};
        ...
        drawGraph: function () {
            var a = this, b = this.options, c = [["graph", b.lineColor || this.color, b.dashStyle]], d = b.lineWidth, e = b.linecap !== "square", f = this.getGraphPath(), g = this.fillGraph && this.color || S;
        ...
        applyZones: function () {
            var a = this, b = this.chart, c = b.renderer, d = this.zones, e, f, g = this.clips || [], h, i = this.graph, j = this.area, k = t(b.chartWidth, b.chartHeight), l = this[(this.zoneAxis || "y") + "Axis"], n, m = l.reversed, u = b.inverted, s = l.horiz, q, y, z, x = !1;
            if (d.length && (i || j) && l.min !== r)i && i.hide(), j && j.hide(), n = l.getExtremes(),
                o(d, function (d, o) {
                    ...
                    z = t(e, f);
                    if (l.isXAxis) {
                        if (h = {x: u ? z : y, y: 0, width: q, height: k}, !s)h.x = b.plotHeight - h.x
                    } else if (h = {x: 0, y: u ? z : y, width: k, height: q}, s)h.y = b.plotWidth - h.y;
        ...
        searchKDTree: function (a, b) {
            function c(a, b, j, k) {
                var l = b.point, n = d.kdAxisArray[j % k], m, o, p = l;
    ...
    q(ma.prototype, {
        addSeries: function (a, b, c) {
            ...
            new Y(this, w(a, {index: this[e].length, isX: b}));
            f[e] = ra(f[e] || {});
            f[e].push(a);
            p(c, !0) && this.redraw(d)
        },
        showLoading: function (a) {
            ...
            if (!d)b.loadingDiv = d = ca(Fa, {className: "highcharts-loading"}, q(e.style, {
                zIndex: 10,
                display: S
            ...
            if (!b.loadingShown)K(d, {
                opacity: 0,
                display: ""
            }), gb(d, {opacity: e.style.opacity}, {duration: e.showDuration || 0}),
                b.loadingShown = !0;
            f()
    ...
    q(Q.prototype, {
        addPoint: function (a, b, c, d) {
            var e = this,
                f = e.options, g = e.data, h = e.graph, i = e.area, j = e.chart, k = e.xAxis && e.xAxis.names, l = h && h.shift || 0, n = ["graph", "area"], h = f.data, m, u = e.xData;
            Ra(d, j);
            if (c) {
            ...
            n = i.x;
            d = u.length;
            if (e.requireSorting && n < u[d - 1])for (m = !0; d && u[d - 1] > n;)d--;
            ...
            var c = this, d = this.chart, e = this.userOptions, f = this.type, g = v[f].prototype, h = ["group", "markerGroup", "dataLabelsGroup"], i;
    ...
    M = $(Q, {
        ...
        getColumnMetrics: function () {
            ...
            c.tickInterval || 1), c.len), k = j * b.groupPadding, l = (j - 2 * k) / i, b = E(b.maxPointWidth || c.len, p(b.pointWidth, l * (1 - 2 * b.pointPadding)));
        ...
        translate: function () {
            ...
            o(a.points, function (c) {
                var d = E(p(c.yBottom, f), 9E4), h = 999 + O(d), h = E(t(-h, c.plotY), e.len + h), o = c.plotX + k, s = j, q = E(h, d), y, z = t(h, d) - q;
                O(z) <
        ...
        drawPoints: function () {
            ...
            o(a.points, function (h) {
                ...
                if (i !== r && !isNaN(i) && h.y !== null)f =
                    h.shapeArgs, i = x(a.borderWidth) ? {"stroke-width": a.borderWidth} : {}, g = h.pointAttr[h.selected ? "select" : ""] || a.pointAttr[""], j ? (Va(j), j.attr(i)[b.pointCount < e ? "animate" : "attr"](w(f))) : h.graphic = d[h.shapeType](f).attr(i).attr(g).add(h.group || a.group).shadow(c.shadow, null, c.stacking && !c.borderRadius); else if (j)h.graphic = j.destroy()
            })
        },
        animate: function (a) {
    ...
    Q.prototype.drawDataLabels = function () {
        ...
        if (d.enabled || a._hasPointLabels)a.dlProcessOptions && a.dlProcessOptions(d), j = a.plotGroup("dataLabelsGroup",
            "data-labels", d.defer ? "hidden" : "visible", d.zIndex || 6), p(d.defer, !0) && (j.attr({opacity: +h}), h || L(a, "afterAnimate", function () {
            a.visible && j.show();
            j[b.animation ? "animate" : "attr"]({opacity: 1}, {duration: 200})
        })), g = d, o(e, function (e) {
            var h, m = e.dataLabel, o, s, t = e.connector, y = !0, z, v = {};
            ...
            if (m && !h)e.dataLabel = m.destroy(); else if (h) {
                ...
                if (m)if (x(i))m.attr({text: i}), y = !1; else {
    ...
    Q.prototype.alignDataLabel = function (a, b, c, d, e) {
        var f = this.chart, g = f.inverted, h = p(a.plotX, -999), i = p(a.plotY, -999), j = b.getBBox(), k = f.renderer.fontMetrics(c.style.fontSize).b, l = this.visible && (a.series.forceDL || f.isInsidePlot(h, A(i), g) || d && f.isInsidePlot(h, g ? d.x + 1 : d.y + d.height - 1, g));
        if (l)d = q({
            x: g ? f.plotWidth - i : h,
            y: A(g ? f.plotHeight - h : i),
            width: 0,
            height: 0
        }, d), q(c, {width: j.width, height: j.height}), c.rotation ? (a = f.renderer.rotCorr(k, c.rotation),
            b[e ? "attr" : "animate"]({
        ...
        if (!l)Va(b), b.attr({y: -999}), b.placed = !1
    };
    ...
    if (v.pie)v.pie.prototype.drawDataLabels = function () {
        var a = this, b = a.data, c, d = a.chart, e = a.options.dataLabels, f = p(e.connectorPadding, 10), g = p(e.connectorWidth, 1), h = d.plotWidth, i = d.plotHeight,
            j, k, l = p(e.softConnector, !0), n = e.distance, m = a.center, u = m[2] / 2, s = m[1], q = n > 0, y, z, r, x = [[], []], w, v, B, C, F, D = [0, 0, 0, 0], K = function (a, b) {
                return b.y - a.y
            };
        if (a.visible && (e.enabled || a._hasPointLabels)) {
                ...
                if (J) {
                    ...
                    if (n > 0) {
                        ...
                        for (F = 0; F < J; F++) {
                            ...
                            if (H < F && I[F] !== null)H = F; else for (z < J - F + H && I[F] !== null && (H = z - J + F); I[H] === null;)H++;
                            L.push({i: H, y: I[H]});
                            I[H] = null
                        }
                        L.sort(K)
                    ...
                    for (F = 0; F < J; F++) {
                        ...
                        y._attr = {visibility: B, align: r[6]};
                        y._pos = {x: w + e.x + ({left: f, right: -f}[r[6]] || 0), y: v + e.y - 10};
                        y.connX = w;
                        y.connY = v;
            ...
            if (Ea(D) === 0 || this.verifyDataLabelOverflow(D))this.placeDataLabels(), q && g && o(this.points, function (b) {
                j =
                    b.connector;
                r = b.labelPos;
                if ((y = b.dataLabel) && y._pos && b.visible)B = y._attr.visibility, w = y.connX, v = y.connY, k = l ? ["M", w + (r[6] === "left" ? 5 : -5), v, "C", w, v, 2 * r[2] - r[4], 2 * r[3] - r[5], r[2], r[3], "L", r[4], r[5]] : ["M", w + (r[6] === "left" ? 5 : -5), v, "L", r[2], r[3], "L", r[4], r[5]], j ? (j.animate({d: k}), j.attr("visibility", B)) : b.connector = j = a.chart.renderer.path(k).attr({
                    "stroke-width": g,
    ...
    if (v.column)v.column.prototype.alignDataLabel = function (a, b, c, d, e) {
        ...
        if (h && (d = w(h), f && (d = {
                x: g.yAxis.len -
                d.y - d.height, y: g.xAxis.len - d.x - d.width, width: d.height, height: d.width
    ...
    q(Za.prototype, {
        defaultColorAxisOptions: {
            ...
            d = w(this.defaultColorAxisOptions, {side: c ? 2 : 1, reversed: !c}, b, {
                opposite: !c, showEmpty: !1,
                title: null, isColor: !0
            });
            ...
            var b = this, c = this.chart,
                d, e = 0, f = this.options, g = a.dataClasses.length;
            this.dataClasses = d = [];
            this.legendItems = [];
        ...
        }, setState: T, visible: !0, setVisible: T, getSeriesExtremes: function () {
            var a;
    ...
    var Kb = $(Z, q({
        applyOptions: function (a, b) {
            var c = Z.prototype.applyOptions.call(this, a, b), d = this.series, e = d.joinBy;
            ...
            if (this.value !== null)Z.prototype.onMouseOver.call(this, a); else this.series.onMouseOut(a)
        }, onMouseOut: function () {
            var a = this, b = +new Ga, c = W(a.color), d = W(a.pointAttr.hover.fill), e = a.series.options.states.normal.animation, f = e && (e.duration || 500), g;
    ...
    v.map = $(v.scatter, w(Jb, {
        ...
        getBox: function (a) {
            ...
            o(a || [], function (a) {
                if (a.path) {
                    ...
                    var h = a.path || [], i = h.length, m = !1, o = -b, s = b, q = -b, r = b, t = a.properties;
                    if (!a._foundBox) {
        ...
        translatePath: function (a) {
            var b = !1, c = this.xAxis, d = this.yAxis, e = c.min, f = c.transA, c = c.minPixelPadding, g = d.min, h = d.transA, d = d.minPixelPadding,
                i, j = [];
        ...
        setData: function (a, b) {
            ...
            if (d) {
                if (d.type === "FeatureCollection") {
                    if (d["hc-transform"])for (h in this.chart.mapTransforms = i = d["hc-transform"], i)if (i.hasOwnProperty(h) && h.rotation)h.cosAngle =
        ...
        drawPoints: function () {
            ...
            if (!a.transformGroup)a.transformGroup =
                f.g().attr({scaleX: 1, scaleY: 1}).add(d), a.transformGroup.survive = !0;
        ...
        render: function () {
            var a = this, b = Q.prototype.render;
    ...
    (function (a) {
        var b = a.Chart, c = a.each, d = a.pick,
        ...
        b.prototype.hideOverlappingLabels = function (a) {
            var b = a.length, d, e, j, k, l, n, m;
            for (e = 0; e <
            b; e++)if (d = a[e])d.oldOpacity = d.opacity, d.newOpacity = 1;
            a.sort(function (a, b) {
                return (b.labelrank || 0) - (a.labelrank || 0)
            });
            for (e = 0; e < b; e++) {
                j = a[e];
                for (d = e + 1; d < b; ++d)if (k = a[d], j && k && j.placed && k.placed && j.newOpacity !== 0 && k.newOpacity !== 0 && (l = j.alignAttr, n = k.alignAttr, m = 2 * (j.box ? 0 : j.padding), l = !(n.x > l.x + (j.width - m) || n.x + (k.width - m) < l.x || n.y > l.y + (j.height - m) || n.y + (k.height - m) < l.y)))(j.labelrank < k.labelrank ? j : k).newOpacity = 0
            }
            c(a, function (a) {
                var b, c;
                if (a) {
    ...
    q(ma.prototype, {
        renderMapNavigation: function () {
            ...
            if (p(b.enableButtons, b.enabled) && !a.renderer.forExport)for (d in c)if (c.hasOwnProperty(d))f = w(b.buttonOptions, c[d]), e = f.theme,
    ...
    v.mappoint = $(v.scatter, {
        type: "mappoint", forceDL: !0, pointClass: $(Z, {
            applyOptions: function (a, b) {
    ...
    v.bubble = $(v.scatter, {
        ...
        getRadii: function (a, b, c, d) {
            var e, f, g, h = this.zData, i = [], j = this.options, k = j.sizeBy !== "width", l = j.zThreshold, n = b - a;
        ...
        drawLegendSymbol: function (a, b) {
            ...
            b.legendSymbol = this.chart.renderer.circle(c, a.baseline - c,
                c).attr({zIndex: 3}).add(b.legendGroup);
    ...
    Y.prototype.beforePadding = function () {
        var a = this, b = this.len, c = this.chart, d = 0, e = b, f = this.isXAxis, g = f ? "xData" : "yData", h = this.min, i = {}, j = G.min(c.plotWidth, c.plotHeight), k = Number.MAX_VALUE, l = -Number.MAX_VALUE, n = this.max - h, m = b / n, q = [];
        o(this.series, function (b) {
            var d = b.options;
        ...
        o(q, function (a) {
            var b = a[g], c = b.length, i;
            f && a.getRadii(k, l, a.minPxSize, a.maxPxSize);
            if (n > 0)for (; c--;)typeof b[c] === "number" && (i = a.radii[c], d = Math.min((b[c] - h) * m - i, d), e = Math.max((b[c] - h) * m + i, e))
        });
        q.length && n > 0 && !this.isLog &&
        (e -= b, m *= (b + d - e) / b, o([["min", "userMin", d], ["max", "userMax", e]], function (b) {
    ...
    ma.prototype.transformFromLatLon = function (a, b) {
        if (window.proj4 === void 0)return da(21), {x: 0, y: null};
    ...
    ma.prototype.transformToLatLon = function (a, b) {
        if (window.proj4 === void 0)da(21); else {
            var c = {
    ...
    ma.prototype.fromPointToLatLon = function (a) {
        ...
        if (b) {
            for (c in b)if (b.hasOwnProperty(c) && b[c].hitZone && Cb({
                    x: a.x,
                    y: -a.y
    ...
    ma.prototype.fromLatLonToPoint = function (a) {
        ...
        if (!b)return da(22), {x: 0, y: null};
        for (c in b)if (b.hasOwnProperty(c) && b[c].hitZone && (d = this.transformFromLatLon(a, b[c]), Cb({
                x: d.x,
                y: -d.y
    ...
    B.geojson = function (a, b, c) {
        ...
        o(a.features, function (a) {
            ...
            b === "map" || b === "mapbubble" ? (i === "Polygon" ? (o(c, f), e.push("Z")) : i === "MultiPolygon" && (o(c, function (a) {
                o(a, f)
            }), e.push("Z")), e.length && (j = {path: e})) : b === "mapline" ? (i ===
            "LineString" ? f(c) : i === "MultiLineString" && o(c, f), e.length && (j = {path: e})) : b === "mappoint" && i === "Point" && (j = {
                x: c[0],
                y: -c[1]
            });
            j && d.push(q(j, {name: a.name || a.NAME, properties: a}))
        });
        if (c && a.copyrightShort)c.chart.mapCredits = '<a href="http://www.highcharts.java">Highcharts</a> \u00a9 <a href="' + a.copyrightUrl + '">' + a.copyrightShort + "</a>", c.chart.mapCreditsFull = a.copyright;
        return d
    };
    ...
    J.plotOptions.heatmap = w(J.plotOptions.scatter, {
        ...
        }, marker: null, pointRange: null, tooltip: {pointFormat: "{point.x}, {point.y}: {point.value}<br/>"},
    ...
    v.heatmap = $(v.scatter, w(Jb, {
        ...
        translate: function () {
            var a = this.options, b = this.xAxis, c = this.yAxis, d = function (a, b,
                                                                                c) {
                return Math.min(Math.max(b, a), c)
            };
            this.generatePoints();
            o(this.points, function (e) {
                var f = (a.colsize || 1) / 2, g = (a.rowsize || 1) / 2, h = d(Math.round(b.len - b.translate(e.x - f, 0, 1, 0, 1)), 0, b.len), f = d(Math.round(b.len - b.translate(e.x + f, 0, 1, 0, 1)), 0, b.len), i = d(Math.round(c.translate(e.y - g, 0, 1, 0, 1)), 0, c.len), g = d(Math.round(c.translate(e.y + g, 0, 1, 0, 1)), 0, c.len);
                e.plotX = e.clientX = (h + f) / 2;
                e.plotY = (i + g) / 2;
                e.shapeType = "rect";
                e.shapeArgs = {x: Math.min(h, f), y: Math.min(i, g), width: Math.abs(f - h), height: Math.abs(g - i)}
            });
    ...
    Ia = B.TrackerMixin = {
        drawTrackerPoint: function () {
            ...
            var a = this, b = a.options, c = b.trackByArea, d = [].concat(c ? a.areaPath : a.graphPath),
                e = d.length, f = a.chart, g = f.pointer, h = f.renderer, i = f.options.tooltip.snap, j = a.tracker, k = b.cursor, l = k && {cursor: k}, k = a.singlePoints, n, m = function () {
    ...
    q(ma.prototype, {
        showResetZoom: function () {
            ...
            this.resetZoomButton = a.renderer.button(b.resetZoom, null, null, function () {
                a.zoomOut()
            }, d, e && e.hover).attr({align: c.position.align, title: b.resetZoomTitle}).add().align(c.position,
                !1, f)
        }, zoomOut: function () {
            var a = this;
            ...
            o(b === "xy" ? [1, 0] : [1], function (b) {
                ...
                if (h.series.length && (i || l > E(k.dataMin, k.min)) && (!i || j < t(k.dataMax, k.max)))h.setExtremes(l, j, !1, !1, {trigger: "pan"}), e = !0;
    ...
    q(Z.prototype, {
        select: function (a, b) {
            ...
            var c = ga(this.plotX), d = this.plotY, e = this.series, f = e.options.states, g = V[e.type].marker && e.options.marker, h = g && !g.enabled, i = g && g.states[a], j = i && i.enabled === !1, k = e.stateMarkerGraphic, l = this.marker || {}, n = e.chart, m = e.halo, o, a = a || "";
            ...
            if (!(a === this.state && !b || this.selected && a !== "select" || f[a] && f[a].enabled === !1 || a && (j || h && i.enabled === !1) || a && l.states && l.states[a] &&
                ...
                if ((c = f[a] && f[a].halo) && c.size) {
                    ...
                    m.attr(q({fill: W(this.color || e.color).setOpacity(c.opacity).get()}, c.attributes))[b ? "animate" : "attr"]({d: this.haloPath(c.size)})
                } else m && m.attr({d: []});
                this.state = a
            }
        }, haloPath: function (a) {
