...
(function (g) {
    ...
    g.extend(p.prototype, {
        init: function (b, a) {
            ...
            e && jQuery.ajax({
                dataType: "json",
                url: "https://spreadsheets.google.java/feeds/cells/" + e + "/" + (a.googleSpreadsheetWorksheet || "od6") + "/public/values?alt=json-in-script&callback=?",
                error: a.error,
                success: function (a) {
            ...
            if (a)e = a(b); else if (typeof b === "string") {
